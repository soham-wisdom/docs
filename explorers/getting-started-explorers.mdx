...
<Steps>
  <Step icon="magnifying-glass" title="Ask your first question">
    ...
    For complex queries, switch to [**Expert mode**](/chat/expert-mode). Propose your question, and the AI will outline an investigation plan for you before carrying it out in the same chat window.
  </Step>
