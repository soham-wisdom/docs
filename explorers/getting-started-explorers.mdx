...
og:description: "Welcome to WisdomAI. As an Explorer, you are the engine of data-driven decision-making. Your role is to transform raw data into meaningful business reports by"
---
...
<Steps>
  <Step icon="magnifying-glass" title="Ask your first question">
    ...
    For complex queries, switch to [**Expert mode**](/chat/overview#choose-a-mode). Propose your question, and the AI will outline an investigation plan for you before carrying it out in the same chat window.
  </Step>
...
<CardGroup cols={2}>
  <Card icon="message" href="/chat/overview" title="Chat 2.0">
    Explore the new and improved chat experience: reasoning modes, live workstreams, and shareable reports.
  </Card>
