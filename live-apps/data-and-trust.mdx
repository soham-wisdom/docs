...
1. Open the widget's menu. Hover over a chart, KPI, or table and click its three-dot menu. Click **View data source.**
![Widget menu open on a heatmap with View data source and Download source data (CSV) options](/images/view-data-source-live-apps.png)
2. The Data source panel opens with everything behind that widget.
![Data source panel showing how the visual was calculated and the SQL query in the Trajectory section](/images/trajectory-live-apps.png)
...
![Data source panel's View in source dashboard link pointing to the Sources view's three tiles](/images/view-sources-live-apps.png)
...
![Data source panel's View in source dashboard link pointing to the Code view's GeneratedApp.jsx file](/images/souce-code-live-apps.png)
...
![Refresh data tooltip over the Updated 1 minute ago label at the top of the app](/images/refresh-data-live-apps.png)
