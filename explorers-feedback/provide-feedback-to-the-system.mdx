...
<CardGroup cols={2}>
  <Card icon="rocket" href="/setting-up-wisdom-ai/basic-tutorial-connect-and-test" title="Connect and Test Tutorial">
    Walk through the initial setup to connect a data source and run your first query.
  </Card>
  <Card icon="book-open" href="/improve-wisdom-ai-responses/validate-and-test-answers" title="Validate and Test Answers">
