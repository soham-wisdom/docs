...
### Capabilities shared with Customer On-Prem

The following are not Customer On-Prem-only, they apply to Cloud-Prem as well:
...
### Capabilities shared with Cloud-Prem

The following also apply to Cloud-Prem, they are not unique to Customer On-Prem:
...
The following questions cover common concerns about data handling in Customer On-Prem deployments.
...
| Who operates it | WisdomAI (managed, remote access) | You | WisdomAI |
| Object store & Postgres | Cloud provider managed primitives | You provide your own | WisdomAI-provided |
| BYO Identity Provider | ✓ | ✓ | N/A |
| BYO LLM | ✓ | ✓ | N/A |
| Data stays in your environment | ✓ | ✓ | N/A |
