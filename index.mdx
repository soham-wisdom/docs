...
<PageWrapper>
  ...
  <Columns cols={3}>
    ...
    <HomeCard href="/integrations/graphql-api/GraphQL-API" src="/images/home/light/card5-1.png" darkSrc="/images/home/dark/card5.png" title="Developers" description="Integrate via GraphQL API, embeddings, iframe, MCP Server, and SDK" />
