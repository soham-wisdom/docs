...
- Have Admin access to your WisdomAI account. Read the [How to Request an Environment] [TODO-Add-Link] guide to know more about it.
...
3. Select the **Data Source** type.
   ...
   <Info>
     Access <u>Supported Data Sources</u> to see the complete list of supported datasources by WisdomAI.
   </Info>
...
6. Click on **Save and continue**. Now you are ready to start testing WisdomAI chatbot to retrieve information and generate reports about your business.
