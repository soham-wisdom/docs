...
<Frame>
  <img
    src="/images/share-dashboard.png"
    alt="Share Dashboard"
    lightAlt="Share Dashboard"
    darkAlt="Share Dashboard"
    className="dark:hidden"
  />
  <img
    src="/dark-img/share-dashboard.png"
    alt="Share Dashboard"
    lightAlt="Share Dashboard"
    darkAlt="Share Dashboard"
...
<Tip>
  ...
  <Frame>
    <img
      ...
      lightAlt="Share from Dashboard"
      darkAlt="Share from Dashboard"
      className="dark:hidden"
    />
    <img
      src="/dark-img/share-dashboard-icon.png"
      alt="Share from Dashboard"
      lightAlt="Share from Dashboard"
      darkAlt="Share from Dashboard"
      className="hidden dark:block"
...
/>
<img
  src="/dark-img/share-dashboard03.png"
  alt="Share Dashboard"
  lightAlt="Share Dashboard"
  darkAlt="Share Dashboard"
  className="hidden dark:block"
