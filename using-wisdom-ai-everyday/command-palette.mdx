...
og:description: "The command palette is a keyboard-first launcher for WisdomAI. Open it with a single shortcut to jump to any chat, dashboard, domain, connection, or settings"
---
