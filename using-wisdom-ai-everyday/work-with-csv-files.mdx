...
<img
  alt="Create Table From Csv Domain01"
  lightAlt="Create Table From Csv Domain01"
  darkAlt="Create Table From Csv Domain01"
  src="/images/create_table_from_csv_domain01.png"
...
<img
  ...
  lightAlt="Create Table From Csv Domain01"
  darkAlt="Create Table From Csv Domain01"
  src="/dark-img/create_table_from_csv_domain01.png"
...
5. If replacing data, select the specific table to be replaced from the **Select table to replace** dropdown.
   <img
     alt="Upload CSV dialog with 'Replace an existing CSV table' selected, a dropdown to choose the table to replace, and a confirmation state indicating the CSV file is ready for upload"
     lightAlt="Upload CSV dialog with 'Replace an existing CSV table' selected, a dropdown to choose the table to replace, and a confirmation state indicating the CSV file is ready for upload"
     darkAlt="Upload CSV dialog with 'Replace an existing CSV table' selected, a dropdown to choose the table to replace, and a confirmation state indicating the CSV file is ready for upload"
     src="/images/upload-csv-0301.png"
     className="dark:hidden"
   />
   <img
     alt="Upload CSV dialog with 'Replace an existing CSV table' selected, a dropdown to choose the table to replace, and a confirmation state indicating the CSV file is ready for upload"
     lightAlt="Upload CSV dialog with 'Replace an existing CSV table' selected, a dropdown to choose the table to replace, and a confirmation state indicating the CSV file is ready for upload"
     darkAlt="Upload CSV dialog with 'Replace an existing CSV table' selected, a dropdown to choose the table to replace, and a confirmation state indicating the CSV file is ready for upload"
     src="/dark-img/upload-csv-0301.png"
     className="hidden dark:block"
   />
...
<img
  alt="Upload Csv 0401"
  lightAlt="Upload Csv 0401"
  darkAlt="Upload Csv 0401"
  src="/images/upload-csv-0401.png"
  className="dark:hidden"
/>
<img
  alt="Upload Csv 0401"
  lightAlt="Upload Csv 0401"
  darkAlt="Upload Csv 0401"
  src="/dark-img/upload-csv-0401.png"
  className="hidden dark:block"
/>
...
<img
  alt="Upload Csv 09"
  lightAlt="Upload Csv 09"
  darkAlt="Upload Csv 09"
  src="/images/upload-csv-09.png"
  className="dark:hidden"
/>
<img
  alt="Upload Csv 09"
  lightAlt="Upload Csv 09"
  darkAlt="Upload Csv 09"
  src="/dark-img/upload-csv-09.png"
  className="hidden dark:block"
/>
...
<img
  src="/images/upload-csv-10.png"
  alt="Upload Csv 10"
  lightAlt="Upload Csv 10"
  darkAlt="Upload Csv 10"
  className="dark:hidden"
/>
<img
  src="/dark-img/upload-csv-10-1.png"
  alt="Upload Csv 10"
  lightAlt="Upload Csv 10"
  darkAlt="Upload Csv 10"
  className="hidden dark:block"
...
<img
  src="/images/upload-csv-01.png"
  alt="Image showing the Upload CSV option"
  lightAlt="Image showing the Upload CSV option"
  darkAlt="Image showing the Upload CSV option"
  className="dark:hidden"
/>
<img
  src="/dark-img/upload-csv-01.png"
  alt="Image showing the Upload CSV option"
  lightAlt="Image showing the Upload CSV option"
  darkAlt="Image showing the Upload CSV option"
  className="hidden dark:block"
...
<img
  src="/images/upload-csv-method2-01.png"
  alt="Upload CSV modal window with the Continue button highlighted"
  lightAlt="Upload CSV modal window with the Continue button highlighted"
  darkAlt="Upload CSV modal window with the Continue button highlighted"
  className="dark:hidden"
/>
<img
  src="/dark-img/upload-csv-method2-01.png"
  alt="Upload CSV modal window with the Continue button highlighted"
  lightAlt="Upload CSV modal window with the Continue button highlighted"
  darkAlt="Upload CSV modal window with the Continue button highlighted"
  className="hidden dark:block"
...
<img
  src="/images/upload-csv-method2-02.png"
  alt="Preview CSV file modal window with the Configure columns button highlighted"
  lightAlt="Preview CSV file modal window with the Configure columns button highlighted"
  darkAlt="Preview CSV file modal window with the Configure columns button highlighted"
  className="dark:hidden"
/>
<img
  src="/dark-img/upload-csv-method2-02-2.png"
  alt="Preview CSV file modal window with the Configure columns button highlighted"
  lightAlt="Preview CSV file modal window with the Configure columns button highlighted"
  darkAlt="Preview CSV file modal window with the Configure columns button highlighted"
  className="hidden dark:block"
...
<img
  src="/images/upload-csv-method2-03.png"
  alt="Upload Csv Method2 03"
  lightAlt="Upload Csv Method2 03"
  darkAlt="Upload Csv Method2 03"
  className="dark:hidden"
/>
<img
  src="/dark-img/upload-csv-method2-03.png"
  alt="Upload Csv Method2 03"
  lightAlt="Upload Csv Method2 03"
  darkAlt="Upload Csv Method2 03"
  className="hidden dark:block"
...
<img
  src="/images/attach-files-chat.png"
  alt="Snippet showing the attach files to chat button"
  lightAlt="Snippet showing the attach files to chat button"
  darkAlt="Snippet showing the attach files to chat button"
  className="dark:hidden"
/>
<img
  src="/dark-img/attach-files-chat.png"
  alt="Snippet showing the attach files to chat button"
  lightAlt="Snippet showing the attach files to chat button"
  darkAlt="Snippet showing the attach files to chat button"
  className="hidden dark:block"
