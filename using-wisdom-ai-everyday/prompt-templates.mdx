...
og:description: "Prompt templates allow you to turn successful queries into reusable building blocks for other users. Instead of starting from scratch, Explorers can use these"
---
