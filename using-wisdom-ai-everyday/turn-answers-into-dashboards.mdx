...
<Frame>
  ![NEW UI Add To Dashboard01](/images/NEW-UI-add-to-dashboard01.png)
</Frame>
...
<Frame>
  ![NEW UI Add To Dashboard02](/images/NEW-UI-add-to-dashboard02.png)
</Frame>
...
<Frame>
  ![Create Dashboards from the Editor](/images/NEW-UI-add-to-dashboard03.png)
</Frame>
...
<Frame>
  ![Dashboards view](/images/NEW-UI-add-to-dashboard04.png)
</Frame>

## Next Steps

<CardGroup cols={2}>
  <Card icon="calendar-days" href="/using-wisdom-ai-everyday/share-dashboards-and-set-access-control" title="Schedule Dashboard Notifications">
    Set up automated notifications to keep stakeholders updated with the latest story insights.
  </Card>
  <Card icon="share-nodes" href="/using-wisdom-ai-everyday/share-dashboards-and-set-access-control" title="Share Dashboards and Set Access Control">
