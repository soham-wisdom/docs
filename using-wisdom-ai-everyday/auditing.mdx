...
<img
  alt="Image showing the chat section and the rename it modal"
  lightAlt="Image showing the chat section and the rename it modal"
  darkAlt="Image showing the chat section and the rename it modal"
  src="/images/rename-chatv2.png"
...
<img
  ...
  lightAlt="Image showing the chat section and the rename it modal"
  darkAlt="Image showing the chat section and the rename it modal"
  src="/dark-img/rename-chatv2.png"
...
<img
  alt="Image displaying the Filter by summary option within the Chat Log"
  lightAlt="Image displaying the Filter by summary option within the Chat Log"
  darkAlt="Image displaying the Filter by summary option within the Chat Log"
  src="/images/filter-by-summary.png"
  className="dark:hidden"
/>
<img
  alt="Image displaying the Filter by summary option within the Chat Log"
  lightAlt="Image displaying the Filter by summary option within the Chat Log"
  darkAlt="Image displaying the Filter by summary option within the Chat Log"
  src="/dark-img/filter-by-summary.png"
  className="hidden dark:block"
/>
...
<img
  alt="The Chat Log interface is displayed showing a list of chats with metadata like user, domain, and number of responses"
  lightAlt="The Chat Log interface is displayed showing a list of chats with metadata like user, domain, and number of responses"
  darkAlt="The Chat Log interface is displayed showing a list of chats with metadata like user, domain, and number of responses"
  src="/images/chat-log-interface.png"
  className="dark:hidden"
/>
<img
  alt="The Chat Log interface is displayed showing a list of chats with metadata like user, domain, and number of responses"
  lightAlt="The Chat Log interface is displayed showing a list of chats with metadata like user, domain, and number of responses"
  darkAlt="The Chat Log interface is displayed showing a list of chats with metadata like user, domain, and number of responses"
  src="/dark-img/chat-log-interface.png"
  className="hidden dark:block"
/>
...
<img
  alt="View Details window displayed"
  lightAlt="View Details window displayed"
  darkAlt="View Details window displayed"
  src="/images/view-details-window.png"
  className="dark:hidden"
/>
<img
  alt="View Details window displayed"
  lightAlt="View Details window displayed"
  darkAlt="View Details window displayed"
  src="/dark-img/view-details-window.png"
  className="hidden dark:block"
/>
...
<img
  alt="The share vetted answers interface is displayed"
  lightAlt="The share vetted answers interface is displayed"
  darkAlt="The share vetted answers interface is displayed"
  src="/images/share-vetted-answers-01.png"
  className="dark:hidden"
/>
<img
  alt="The share vetted answers interface is displayed"
  lightAlt="The share vetted answers interface is displayed"
  darkAlt="The share vetted answers interface is displayed"
  src="/dark-img/share-vetted-answers-01-1.png"
  className="hidden dark:block"
/>
...
<img
  alt="Sharing options dialog with dropdowns for users, organization toggle, and public link generation"
  lightAlt="Sharing options dialog with dropdowns for users, organization toggle, and public link generation"
  darkAlt="Sharing options dialog with dropdowns for users, organization toggle, and public link generation"
  src="/images/share-vetted-answers-02v2.png"
  className="dark:hidden"
/>
<img
  alt="Sharing options dialog with dropdowns for users, organization toggle, and public link generation"
  lightAlt="Sharing options dialog with dropdowns for users, organization toggle, and public link generation"
  darkAlt="Sharing options dialog with dropdowns for users, organization toggle, and public link generation"
  src="/dark-img/share-vetted-answers-02v2.png"
  className="hidden dark:block"
/>
