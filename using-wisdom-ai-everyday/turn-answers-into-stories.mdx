...
![STORIES Visual Pn](/images/STORIES-visual.png)
...
![Create Stories from the Story Editor](/images/fromstory3-4.png)
...
![Create Stories from the Story Editor](/images/fromstory5.png)

1. Click on the **Add latest visualization as a widget** button. Your Story is now created and saved.

![Create Stories from the Story Editor](/images/fromstory6.png)