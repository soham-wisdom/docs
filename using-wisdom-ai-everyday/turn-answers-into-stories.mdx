...
This guide is intended for all WisdomAI users: from Explorers who explore data insights to Admins who manage and share reports. Follow these steps to create Stories and effectively communicate your insights by turning raw data into clear, engaging narratives that everyone on your team can understand and act upon.
...
5. The **Add visualization widget** modal window will open.  In this window, you can ask WisdomAI a question about your data in natural language. Based on your query, WisdomAI generates a visual representation, such as a chart or graph that you can review and add directly to the Story.
6. Click on the **Add latest visualization as a widget** button.
