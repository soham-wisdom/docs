...
Stories in WisdomAI are interactive, shareable dashboard-like narratives that transform complex data analyses into compelling visual presentations. This functionality allows you to create, customize, and share interactive data narratives and dashboards that update automatically as your data changes.

Follow this guide to create Stories and effectively communicate your insights by turning raw data into clear, engaging narratives that everyone on your team can understand and act upon.

## Before you Begin: Understand Story Types and Features

You can tailor Stories to fit different purposes and audiences, including deep analysis, real-time monitoring, or automated reporting, based on any of the following types and features: 

- **Analytics Stories**: Deep analytical narratives featuring multiple visualizations, filters, and parameters.

- **Dashboards**: At-a-glance views of KPIs and metrics, optimized for real-time monitoring.

- **Scheduled Exports**: Automated story generation and distribution in various formats such as PDF and Excel.

- **Embedded Analytics**: Stories designed to be embedded within other applications or portals.
