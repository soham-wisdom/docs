...
WisdomAI provides a complete GraphQL API for managing domain knowledge. You can create, read, update, and delete knowledge items programmatically.

Knowledge represents domain-specific information that helps improve AI accuracy. This feature allows you to programmatically manage how the system understands specific terms and processes within your domain.
