...
Here are four key actions to help you ask precise questions:

<CardGroup cols={2}>
  <Card title="Make Clear, Natural Language Questions" icon="question">
    
  </Card>
  <Card title="Use Filters for Better Focus" icon="filter">
    
  </Card>
  <Card title="Plan for Follow-Up Questions" icon="plus">
    
  </Card>
  <Card title="Use Business Terms Set by Admins" icon="check">
...
1. Navigate to the **Search** window, in the left sidebar and **send a question** on the chat.
2. The chat will start preparing the answer. You will be able to see its Workstream: The tool selected, the step by step process, any join constrain validation and then, the final query. Onc its ready, it will send you the **answer**.
