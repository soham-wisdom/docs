...
keywords: ["chat", "use the chat", "chatting", "ask questions"]
boost: 10
---
...
<CardGroup cols={2}>
  ...
  <Card title="Use Autocomplete" icon="wand-magic-sparkles" href="#autocomplete">
...
As you type in the chat, WisdomAI suggests relevant queries based on system learning and the context of your domain, rather than a fixed set of preset templates. These suggestions reflect how your organization actually asks questions within that domain. Press **Tab** to accept a suggestion.
