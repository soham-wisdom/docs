...
<Steps>
  <Step title="Speak Clearly with Natural Language Queries (NLQ)">
  ...
  <Step title="Focus Your Questions with Filters">
  ...
  <Step title="Plan for Follow-Up Questions">
  ...
  <Step title="Use Business Terms Set by Admins">
