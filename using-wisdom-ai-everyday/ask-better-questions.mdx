...
Here are four key actions to help you ask better questions:

<CardGroup cols={2}>
  <Card title="Make Clear, Natural Language Queries" icon="question">
...
## Make Clear, Natural Language Queries (NLQ)
