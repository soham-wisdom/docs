...
<Note>
  **Existing subscriptions**
  ...
  After subscribing to a Dashboard, it will appear in the **Existing Schedules** section the next time you open the **Schedule** option for the same Dashboard. From there, you can **Test** or **Remove** it.
