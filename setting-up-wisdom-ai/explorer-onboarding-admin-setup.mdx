...
description: >-
  This guide provides administrators with instructions to configure the
  onboarding experience for Explorer users.
---
...
**Prompt templates** are generated from the chat interface when a response is marked as ["reviewed"](/improve-wisdom-ai-responses/validate-and-test-answers#4-mark-the-answer-as-reviewed).
