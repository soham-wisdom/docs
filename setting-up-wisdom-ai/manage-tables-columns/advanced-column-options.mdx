...
description: >-
  If you toggle the Show advanced options switch on, the following additional
  configuration fields will appear, allowing for more granular control over
  your...
keywords:
  - primary key
  - allowed values
...
<img
  alt='A table view of database columns showing advanced configuration options, such as Primary Key and Allowed Values, enabled by the "Show advanced options" toggle.'
  lightAlt='A table view of database columns showing advanced configuration options, such as Primary Key and Allowed Values, enabled by the "Show advanced options" toggle.'
  darkAlt='A table view of database columns showing advanced configuration options, such as Primary Key and Allowed Values, enabled by the "Show advanced options" toggle.'
  src="/images/advanced-config-columns.png"
...
<img
  ...
  lightAlt='A table view of database columns showing advanced configuration options, such as Primary Key and Allowed Values, enabled by the "Show advanced options" toggle.'
  darkAlt='A table view of database columns showing advanced configuration options, such as Primary Key and Allowed Values, enabled by the "Show advanced options" toggle.'
  src="/dark-img/advanced-config-columns.png"
