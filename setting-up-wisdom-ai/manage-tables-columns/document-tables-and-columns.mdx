...
description: >-
  Proper documentation of tables and columns provides the foundational context
  required for formal semantic modeling.
keywords:
  - domains
  - display name
  - table description
...
<Frame>
  <img
    alt="The table is listed with the Display name and Description highlighted"
    lightAlt="The table is listed with the Display name and Description highlighted"
    darkAlt="The table is listed with the Display name and Description highlighted"
    src="/images/new-ui-document-tables-description.png"
  ...
  <img
    ...
    lightAlt="The table is listed with the Display name and Description highlighted"
    darkAlt="The table is listed with the Display name and Description highlighted"
    src="/dark-img/new-ui-document-tables-description.png"
...
<Frame>
  <img
    src="/images/new-ui-document-a-table-description.png"
    alt="The column is listed with the Display name and the Descrption highlighted"
    lightAlt="The column is listed with the Display name and the Descrption highlighted"
    darkAlt="The column is listed with the Display name and the Descrption highlighted"
    className="dark:hidden"
  />
  <img
    src="/dark-img/new-ui-document-a-table-description.png"
    alt="The column is listed with the Display name and the Descrption highlighted"
    lightAlt="The column is listed with the Display name and the Descrption highlighted"
    darkAlt="The column is listed with the Display name and the Descrption highlighted"
    className="hidden dark:block"
