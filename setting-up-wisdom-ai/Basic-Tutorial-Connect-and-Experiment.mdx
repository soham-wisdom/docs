...
![Add Connection](/images/add-connection-2-5.png)
...
![Create Domain](/images/create-domain6.png)

## Upload CSV Files

With WisdomAI, you can seamlessly integrate and analyze your existing data stored in CSV files. This common and versatile format allows for quick integration within the platform, enabling you to gain rapid insights directly from your readily available data.

To upload CSV files:

1. Navigate to the **Homepage**.
2. Click on the **Domain switcher**.
3. Select the **Upload CSV** option.
