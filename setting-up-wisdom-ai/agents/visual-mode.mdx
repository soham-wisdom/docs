---
title: "Visual Mode"
og:description: "This guide walks through building an agent using Visual Mode in WisdomAI, from selecting a trigger to publishing your workflow for delivery. If you prefer to"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Nodes Reference" icon="grid" href="/setting-up-wisdom-ai/agents/nodes-reference">
