...
boost: 15
og:description: "Agents are automated workflows that perform intelligent analysis autonomously. Think of an agent as a digital worker you configure once and leave running: it"
---
...
<Frame>
  ![Agent configuration screen in WisdomAI showing Visual Mode canvas](/images/full-screen.png)
</Frame>
...
<Note>
  ...
  - **Visual Mode**, where the WisdomAI Builder generates a visual plan from your description that you review, freeze, and reuse on every run.
...
![Image showing recurring agent in chat](/images/reccuring-agent.png)

## Next steps

<CardGroup cols={2}>
  <Card title="Create an Agent" icon="robot" href="/setting-up-wisdom-ai/agents/tutorial-create-agent">
