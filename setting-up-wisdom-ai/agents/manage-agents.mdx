...
keywords: ["agent", "agents", "manage agents"]
boost: 6
og:description: "After an Agent is created, it appears in a list on the main Agents page. From this page, you can manage all the Agents you have access to."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Use Expert Mode" icon="magnifying-glass-chart" href="/chat/overview#choose-a-mode">
