...
description: >-
  After an Agent is created, it appears in a list on the main Agents page. From
  this page, you can manage all the Agents you have access to.
keywords:
  - agent list
  - agent sharing
  - agent permissions
...
<img
  src="/images/manage-agent-v1.png"
...
/>
<img
  src="/dark-img/manage-agent-v1-2.png"
  alt="Snippet showing the options to manage an agent"
  lightAlt="Snippet showing the options to manage an agent"
  darkAlt="Snippet showing the options to manage an agent"
