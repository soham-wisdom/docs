...
description: >-
  The Has Limited Context marker is a key signal for monitoring the quality of
  WisdomAI responses.
keywords:
  - knowledge gaps
  - low confidence answers
  - chat log filter
  - incomplete context marker
---
...
<img
  alt="Image showing the Has Limited Context switch"
  lightAlt="Image showing the Has Limited Context switch"
  darkAlt="Image showing the Has Limited Context switch"
  src="/images/new-ui-has-limited-context.png"
...
<img
  ...
  lightAlt="Image showing the Has Limited Context switch"
  darkAlt="Image showing the Has Limited Context switch"
  src="/dark-img/has-limited-context.png"
...
<Frame>
  ![Limited Context Marker](/images/Limited-Context-marker.gif)
</Frame>
