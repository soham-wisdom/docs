...
Administrators are responsible for identifying and acting upon Limited Context markers to maintain the precision of the domain configuration. To make the most of this feature:
...
## Validate the Response
    ...
    ![Gif showing how to provide negative feedback](/images/feedback.gif)
