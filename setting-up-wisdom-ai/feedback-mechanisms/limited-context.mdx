...
Limited Context markers are displayed next to generated visualizations or answers. Access **View details**, hover over the Limited Context [\!] marker and thumbs down (👎) icon to view more details about knowledge gaps or uncertainties that affected the response.
