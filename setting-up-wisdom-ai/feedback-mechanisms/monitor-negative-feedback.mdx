...
description: >-
  Administrators are responsible for reviewing and acting upon the negative
  feedback provided by all users.
---
...
<img
  src="/images/new-ui-negative-feedback-chat-log-v2.png"
  alt="Chat Log tab with the Has Negative Feedback toggle on"
  title="Negative Feedback Chat Log Pn"
  style={{ width:"100%" }}
  lightAlt="Chat Log tab with the Has Negative Feedback toggle on"
  darkAlt="Chat Log tab with the Has Negative Feedback toggle on"
  className="dark:hidden"
/>
<img
  src="/dark-img/new-ui-negative-feedback-chat-log-v2.png"
  alt="Chat Log tab with the Has Negative Feedback toggle on"
  title="Negative Feedback Chat Log Pn"
  style={{ width:"100%" }}
  lightAlt="Chat Log tab with the Has Negative Feedback toggle on"
