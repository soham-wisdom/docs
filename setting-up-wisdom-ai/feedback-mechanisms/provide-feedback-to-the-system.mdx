...
og:description: "Your feedback is essential for improving WisdomAI's accuracy and reliability. By rating answers and providing corrections, you help the system learn and refine"
---
...
<img
  ...
  style={{ width:"84%" }}
  lightAlt="Image showing the Thumb Down action in chat"
  darkAlt="Image showing the Thumb Down action in chat"
  src="/images/new-ui-thumb-downv2.png"
...
<img
  ...
  lightAlt="Image showing the Thumb Down action in chat"
  darkAlt="Image showing the Thumb Down action in chat"
  src="/dark-img/new-ui-thumb-downv2.png"
