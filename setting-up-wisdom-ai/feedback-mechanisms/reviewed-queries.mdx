...
<Frame>
  ![Import CSV File button shown](/images/new-ui-import-csv.png)
</Frame>
...
While Validated Queries are powerful, some complex business rules are best enforced by pairing them with explicit instructions in your **Language Knowledge**. Validated Queries teach the model _how_ to calculate a specific metric, while Language Knowledge can teach it _what not to do_ to avoid common logical errors.
...
<CardGroup cols={2}>
  <Card icon="puzzle-piece" href="/setting-up-wisdom-ai/feedback-mechanisms/limited-context" title="Limited Knowledge">
  ...
  <Card icon="thumbs-down" href="/setting-up-wisdom-ai/feedback-mechanisms/monitor-negative-feedback" title="Monitor Negative Feedback">
