...
<Frame>
  <img
    alt="Image showing the Review a Question modal"
    lightAlt="Image showing the Review a Question modal"
    darkAlt="Image showing the Review a Question modal"
    src="/images/new-ui-review-question-v02-em.png"
  ...
  <img
    ...
    lightAlt="Image showing the Review a Question modal"
    darkAlt="Image showing the Review a Question modal"
    src="/dark-img/new-ui-review-question-v02-1.png"
...
<Frame>
  <img
    alt="Image showing the Edit Sql option in chat"
    lightAlt="Image showing the Edit Sql option in chat"
    darkAlt="Image showing the Edit Sql option in chat"
    src="/images/new-ui-edit-sql-0925.png"
    className="dark:hidden"
  />
  <img
    alt="Image showing the Edit Sql option in chat"
    lightAlt="Image showing the Edit Sql option in chat"
    darkAlt="Image showing the Edit Sql option in chat"
    src="/dark-img/new-ui-edit-sql-0925.png"
    className="hidden dark:block"
  />
</Frame>
...
<Frame>
  <img
    alt="Image showing the Edited SQL"
    lightAlt="Image showing the Edited SQL"
    darkAlt="Image showing the Edited SQL"
    src="/images/new-ui-sql-edited-0925.png"
    className="dark:hidden"
  />
  <img
    alt="Image showing the Edited SQL"
    lightAlt="Image showing the Edited SQL"
    darkAlt="Image showing the Edited SQL"
    src="/dark-img/sql-edited-0925.png"
    className="hidden dark:block"
  />
</Frame>

After applying the change and seeing the updated quarterly chart, you can save this improved version. You would click **Mark as reviewed** and update the question to **“Show me the quarterly ARR trend”** to save it as a new, more specific Reviewed Query for future use.
...
<Frame>
  <img
    ...
    lightAlt="Image showing the Review a Question modal"
    darkAlt="Image showing the Review a Question modal"
    src="/images/new-ui-review-question-sql-0925.png"
    className="dark:hidden"
  />
  <img
    alt="Image showing the Review a Question modal"
    lightAlt="Image showing the Review a Question modal"
    darkAlt="Image showing the Review a Question modal"
    src="/dark-img/review-question-sql-0925.png"
    className="hidden dark:block"
  />
</Frame>
...
<Frame>
  <img
    alt="Import CSV File button shown"
    lightAlt="Import CSV File button shown"
    darkAlt="Import CSV File button shown"
    src="/images/new-ui-v2-import-csv-1.png"
    className="dark:hidden"
  />
  <img
    alt="Import CSV File button shown"
    lightAlt="Import CSV File button shown"
    darkAlt="Import CSV File button shown"
    src="/dark-img/new-ui-import-csv.png"
    className="hidden dark:block"
  />
</Frame>
...
While a reviewed query can show the correct way to get the population, adding a clear instruction in [language knowledge](/setting-up-wisdom-ai/advanced-data-modeling-creating-context#natural-language-knowledge) provides an extra layer of protection against mistakes:
...
<Frame>
  <img
    alt="Edit Reviewed Queries Chat"
    lightAlt="Edit Reviewed Queries Chat"
    darkAlt="Edit Reviewed Queries Chat"
    src="/images/new-ui-edit-reviewed-queries-chat-3.png"
    className="dark:hidden"
  />
  <img
    alt="Edit Reviewed Queries Chat"
    lightAlt="Edit Reviewed Queries Chat"
    darkAlt="Edit Reviewed Queries Chat"
    src="/dark-img/new-ui-edit-reviewed-queries-chat.png"
    className="hidden dark:block"
  />
</Frame>
