...
og:description: "This guide walks through setting up and using Auto Domain Selection and Domain Groups: Topics include auto domain, create domain group, edit."
---
...
![image showing how to create cross domain](/images/create-cross-domain.png)
2. Under **Domain Groups**, click **Add Group**
![image showing how to add a group](/images/add-group-domains.png)
...
5. Click **Create**
![image showing how to give a name, select domains and save](/images/name-and-domains.png)

The group appears in the domain selector dropdown, marked with a Group chip.

![SCREENSHOT: Domain group creation screen showing domain selection](/images/domain-group-chip.png)
