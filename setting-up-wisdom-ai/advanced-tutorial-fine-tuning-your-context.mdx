...
![Domain Tab](/images/domain-tab.png)
...
![Domain Data Source Tab](/images/data-sources-page.png)
...
<Info>
  To learn more about Defining Metrics with SQL, read [How to Use Metrics](/improve-wisdom-ai-responses/how-to-use-metrics).
</Info>
...
When you add Context, you have the following benefits:
...
<Tabs>
  <Tab title="Chat response before Context enhancement">
    ![Calculation Wo Context Pn](/images/calculation-wo-context.png)
  </Tab>
  <Tab title="Chat response after Context enhancement">
...
Reviewed Queries are a tuple of **a natural language question** and **its ideal SQL response**. By reviewing queries, you can help users get a higher degree of confidence in the answers they receive. This is the most critical aspect of context for the language model to understand your data, since it is directly tied to SQL.
