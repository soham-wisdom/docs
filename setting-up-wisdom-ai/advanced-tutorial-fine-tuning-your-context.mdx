...
- **DATA SOURCES**: This tab is where data administrators manage and model the raw data structure to make it queryable and insightful within the platform. What you can do here to enhance Context is:
  - **Document your tables**: Write clear natural language descriptions for tables and columns to help the AI interpret schema elements accurately.
