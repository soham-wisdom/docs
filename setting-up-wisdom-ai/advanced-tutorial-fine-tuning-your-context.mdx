...
- **Description:** In this field, provide a clear explanation of what the table represents, focusing on a concise, plain-English description of each row’s purpose and content.
...
<Info>
  To learn more about Documenting Tables/Columns and Defining Metrics with SQL, read the related article [TODO-ADD-relatedArticle]
</Info>
