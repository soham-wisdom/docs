...
- **Description:** It is an explanation of what the table represents, which _must_ include a clear statement of what each row's granularity represents in plain English (e.g., "Each row represents a single sales transaction from a point-of-sale system").
