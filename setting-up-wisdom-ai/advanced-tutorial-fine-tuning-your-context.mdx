...
To Document tables, go to **Domains** \> **Data Sources** \> **Tables**.
...
<Info>
  To learn more about Documenting Tables and Columns and Defining Metrics with SQL, refer to [ADD Articles?]
</Info>
