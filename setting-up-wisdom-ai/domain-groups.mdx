...
boost: 3
keywords: ['Auto Domain', 'Domain Groups', 'Groups', 'Auto mode']
og:description: "WisdomAI organizes context into domains, so that a question about billing draws only on billing tables and billing definitions, and a question about product"
---
