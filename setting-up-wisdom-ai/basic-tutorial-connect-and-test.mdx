...
<Frame>
  <img
    alt="Connections and Add Connection screens with the nav item, Add connection button, and data source picker highlighted"
    lightAlt="Connections and Add Connection screens with the nav item, Add connection button, and data source picker highlighted"
    darkAlt="Connections and Add Connection screens with the nav item, Add connection button, and data source picker highlighted"
    src="/images/newui-connections-add-connection.png"
...
<Frame>
  <img
    alt="Redshift Connection Details form with the credentials panel and Save and Sync metadata button highlighted"
    lightAlt="Redshift Connection Details form with the credentials panel and Save and Sync metadata button highlighted"
    darkAlt="Redshift Connection Details form with the credentials panel and Save and Sync metadata button highlighted"
    src="/images/newui-add-connection-details.png"
    className="dark:hidden"
  />
  <img
    alt="Add a Connection"
...
<Frame>
  <img
    alt="Domains list with the Add domain button highlighted in the top-right corner"
    lightAlt="Domains list with the Add domain button highlighted in the top-right corner"
    darkAlt="Domains list with the Add domain button highlighted in the top-right corner"
    src="/images/newui-domains-list.png"
    className="dark:hidden"
  />
  <img
    alt="Create a Domain"
