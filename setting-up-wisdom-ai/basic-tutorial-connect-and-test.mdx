...
description: >-
  This tutorial is intended for Admin users who are responsible for configuring
  data sources and setting up WisdomAI.
---
...
<CardGroup cols={3}>
  ...
  <Card title="Provide Feedback to the System" icon="thumbs-up" href="/explorers-feedback/provide-feedback-to-the-system">
