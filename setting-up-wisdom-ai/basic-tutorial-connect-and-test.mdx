...
<Tip>
  If you want to connect a new source, select this option in step 3. In the next modal window, you'll be able to connect to the Data store, the MCP server, or add files (CSV, TSV).
