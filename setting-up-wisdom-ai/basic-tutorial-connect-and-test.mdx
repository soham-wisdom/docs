...
<Frame>
  <img
    ...
    className="hidden dark:block hidden dark:block hidden dark:block hidden dark:block hidden dark:block hidden dark:block"
  ...
  <img
    ...
    lightAlt="Modal for creating a new domain"
    darkAlt="Modal for creating a new domain"
    className="hidden dark:block hidden dark:block hidden dark:block hidden dark:block hidden dark:block dark:hidden"
    title="Newui Create Domain 02"
  />
  ...
  <img
    ...
    lightAlt="Modal for creating a new domain"
    darkAlt="Modal for creating a new domain"
    className="hidden dark:block hidden dark:block hidden dark:block hidden dark:block dark:hidden"
    title="Newui Create Domain 02"
  />
  ...
  <img
    ...
    lightAlt="Modal for creating a new domain"
    darkAlt="Modal for creating a new domain"
    className="hidden dark:block hidden dark:block hidden dark:block dark:hidden"
    title="Newui Create Domain 02"
  />
  ...
  <img
    ...
    lightAlt="Modal for creating a new domain"
    darkAlt="Modal for creating a new domain"
    className="hidden dark:block hidden dark:block dark:hidden"
    title="Newui Create Domain 02"
  />
