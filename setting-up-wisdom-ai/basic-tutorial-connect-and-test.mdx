...
Most teams complete initial setup in 2–4 hours. Full production readiness typically takes 1–2 weeks.

<Steps>
  <Step title="Connect data source">
    Link your database or data warehouse to WisdomAI.
  </Step>
  <Step title="Model your domain">
    Create a domain and select the tables your team will query.
  </Step>
  <Step title="Add context">
    Document tables, columns, and business logic to improve answer accuracy.
  </Step>
  <Step title="Validate answers">
    Test queries and provide feedback to tune accuracy before launch.
  </Step>
  <Step title="Launch to Explorers">
    Invite your team and share domain access.
  </Step>
</Steps>
