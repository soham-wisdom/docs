...
3. Select the **Data Source** type.
   ...
   <Info>
     Access [Supported Data Sources](/getting-started/connect-data-sources/supported-data-sources) to see the complete list of supported datasources by Wisdom AI.
   </Info>
