---
title: "Quickstart: Connect and Test"
og:description: "This tutorial is intended for Admin users who are responsible for configuring data sources and setting up WisdomAI."
---
...
<Frame>
  <img
    ...
    src="/images/basic-tutorial-add-connection-light.png"
  ...
  <img
    ...
    lightAlt="Connections and Add Connection screens with the nav item, Add connection button, and data source picker highlighted"
    darkAlt="Connections and Add Connection screens with the nav item, Add connection button, and data source picker highlighted"
    src="/dark-img/basic-tutorial-add-connection-dark.png"
...
<Frame>
  ...
  <img
    ...
    lightAlt="Redshift Connection Details form with the credentials panel and Save and Sync metadata button highlighted"
    darkAlt="Redshift Connection Details form with the credentials panel and Save and Sync metadata button highlighted"
    src="/dark-img/basic-tutorial-save-and-sync-dark.png"
    className="hidden dark:block"
  />
</Frame>
...
<Frame>
  <img
    alt="Domains list with the Add domain button highlighted, and the Create New Domain modal with domain name, data source selection, and Create Domain button highlighted"
    lightAlt="Domains list with the Add domain button highlighted, and the Create New Domain modal with domain name, data source selection, and Create Domain button highlighted"
    darkAlt="Domains list with the Add domain button highlighted, and the Create New Domain modal with domain name, data source selection, and Create Domain button highlighted"
    src="/images/create-new-domain-light.png"
    className="dark:hidden"
  />
  <img
    alt="Domains list with the Add domain button highlighted, and the Create New Domain modal with domain name, data source selection, and Create Domain button highlighted"
    lightAlt="Domains list with the Add domain button highlighted, and the Create New Domain modal with domain name, data source selection, and Create Domain button highlighted"
    darkAlt="Domains list with the Add domain button highlighted, and the Create New Domain modal with domain name, data source selection, and Create Domain button highlighted"
    src="/dark-img/create-new-domain-dark.png"
    className="hidden dark:block"
  />
</Frame>
...
While experimenting with your WisdomAI data analyst, you can **train** it by providing **feedback**. There are three main ways to do so:
