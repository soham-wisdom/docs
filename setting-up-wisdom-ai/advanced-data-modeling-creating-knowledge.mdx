...
<Frame>
  ![Image showing the Document Tables interface](/images/new-ui-document-table.png)
</Frame>
...
<Frame>
  ![Image showing the Metrics Tab](/images/new-ui-metrics.png)
</Frame>
...
<Frame>
  ![Image showing the Knowledge Tab](/images/NEW-knowledge-tab.png)
</Frame>
...
![Image showing the Validated Queries tab](/images/new-reviewed-queries-tab.png)
