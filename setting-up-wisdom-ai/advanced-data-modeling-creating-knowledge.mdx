...
<Steps>
  <Step title="Table and Column Documentation">
    ...
    ![Document Tables Pn](/images/document-table.png)
  </Step>
  <Step title="Defining Entities">
    ...
    ![Entity Mapping Pn](/images/entity-mapping.png)
  </Step>
  <Step title="Establishing Relationships">
    ...
    ![Create Relationship Pn](/images/create-relationship.png)
  </Step>
  ...
  <Step title="Data Model Augmentation">
    ...
    ![Derived Table Pn](/images/derived-table.png)
  </Step>
</Steps>
