...
og:description: "Skills are reusable blocks of instructions created by domain and data admins that tell WisdomAI how to handle specific types of messages. When you send a"
---
...
<CardGroup cols={2}>
  <Card title="Create a Skill" icon="wand-magic-sparkles" href="/setting-up-wisdom-ai/manage-domains/create-a-skill">
