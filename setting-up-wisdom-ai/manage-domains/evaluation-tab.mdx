...
og:description: "The Evaluation tab is used to test and validate AI behavior within a domain. Within this section, you can create specific sets of prompts to simulate user"
---
...
<Frame>
  <img
    src="/images/new-ui-evaluation-tab.png"
    alt="UI snippet showing the Evaluation Tab"
    lightAlt="UI snippet showing the Evaluation Tab"
    darkAlt="UI snippet showing the Evaluation Tab"
    className="dark:hidden"
  />
  <img
    src="/dark-img/new-ui-evaluation-tab.png"
    alt="UI snippet showing the Evaluation Tab"
    lightAlt="UI snippet showing the Evaluation Tab"
    darkAlt="UI snippet showing the Evaluation Tab"
