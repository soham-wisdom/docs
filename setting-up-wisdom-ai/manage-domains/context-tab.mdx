---
title: "Context Tab"
keywords: ["entity", "entities", "reviewed queries", "synonyms"]
og:description: "The Context tab is where you define how the AI should understand and respond to your business. Here, you provide domain-specific knowledge, terminology"
---
...
<Frame>
  <img
    ...
    lightAlt="Snippet showing the Context Tab"
    darkAlt="Snippet showing the Context Tab"
  ...
  <img
    ...
    lightAlt="Snippet showing the Context Tab"
    darkAlt="Snippet showing the Context Tab"
    src="/dark-img/NEW-knowledge-tab.png"
...
<Frame>
  <img
    alt="Snippet showing the Reviewed Queries tab"
    lightAlt="Snippet showing the Reviewed Queries tab"
    darkAlt="Snippet showing the Reviewed Queries tab"
  ...
  <img
    ...
    lightAlt="Snippet showing the Reviewed Queries tab"
    darkAlt="Snippet showing the Reviewed Queries tab"
    src="/dark-img/validate-and-test-answers.png"
    className="hidden dark:block"
  />
</Frame>
...
<Frame>
  <img
    alt="Snippet showing the Metrics Tab"
    lightAlt="Snippet showing the Metrics Tab"
    darkAlt="Snippet showing the Metrics Tab"
    src="/images/new-ui-metrics-1.png"
    className="dark:hidden"
  />
  <img
    alt="Snippet showing the Metrics Tab"
    lightAlt="Snippet showing the Metrics Tab"
    darkAlt="Snippet showing the Metrics Tab"
    src="/dark-img/new-ui-metrics-1.png"
    className="hidden dark:block"
  />
</Frame>
...
<Frame>
  <img
    alt="Image showing the Synonyms tab"
    lightAlt="Image showing the Synonyms tab"
    darkAlt="Image showing the Synonyms tab"
    src="/images/new-ui-synonyms.png"
    className="dark:hidden"
  />
  <img
    alt="Image showing the Synonyms tab"
    lightAlt="Image showing the Synonyms tab"
    darkAlt="Image showing the Synonyms tab"
    src="/dark-img/new-ui-synonyms.png"
    className="hidden dark:block"
  />
</Frame>
...
<Frame>
  <img
    alt="Snippet showing the Entities Tab"
    lightAlt="Snippet showing the Entities Tab"
    darkAlt="Snippet showing the Entities Tab"
    src="/images/new-ui-entities.png"
    className="dark:hidden"
  />
  <img
    alt="Snippet showing the Entities Tab"
    lightAlt="Snippet showing the Entities Tab"
    darkAlt="Snippet showing the Entities Tab"
    src="/dark-img/new-ui-entities.png"
    className="hidden dark:block"
  />
</Frame>
