---
title: "Domain Health"
keywords: ["domain health", "domain score"]
boost: 0.15
---
...
<Steps>
  <Step title="Health dimensions" icon="chart-network">
    ...
    - **Schema quality** assesses whether the domain's table and column definitions are clear and usable. It flags cryptic or ambiguous names and overlapping names that lack descriptions.
...
<video src="/videos/domain-health-v1.mp4" autoPlay loop muted playsInline controls />
...
<AccordionGroup>
  <Accordion title="How often does the automated health check run?">
    Analysis runs can be triggered manually from the Domain Health tab. Weekly automated runs can also be enabled, per account and per domain.
  </Accordion>
