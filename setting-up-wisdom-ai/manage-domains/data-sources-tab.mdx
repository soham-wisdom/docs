...
<Frame>
  <img
    src="/images/new-ui-data-sources-tab.png"
    alt="Snippet showing the Data Sources tab within a domain"
    lightAlt="Snippet showing the Data Sources tab within a domain"
    darkAlt="Snippet showing the Data Sources tab within a domain"
    className="dark:hidden"
  />
  <img
    src="/dark-img/new-ui-data-sources-tab.png"
    alt="Snippet showing the Data Sources tab within a domain"
    lightAlt="Snippet showing the Data Sources tab within a domain"
    darkAlt="Snippet showing the Data Sources tab within a domain"
