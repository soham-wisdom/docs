---
title: "Changelog Tab"
og:description: "The Changelog tab provides a chronological record of updates applied to the domain, helping you understand what changed, when it changed, and who made the"
---
...
<Frame>
  <img
    src="/images/new-ui-changelog-tab.png"
    alt="Snippet showing the Changelog Tab within a domain"
    lightAlt="Snippet showing the Changelog Tab within a domain"
    darkAlt="Snippet showing the Changelog Tab within a domain"
    className="dark:hidden"
  />
  <img
    src="/dark-img/new-ui-changelog-tab.png"
    alt="Snippet showing the Changelog Tab within a domain"
    lightAlt="Snippet showing the Changelog Tab within a domain"
    darkAlt="Snippet showing the Changelog Tab within a domain"
