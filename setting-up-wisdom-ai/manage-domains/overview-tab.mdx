---
title: "Overview Tab"
keywords: ["Domain", "domain overview"]
og:description: "The Overview tab serves as a central dashboard, providing a high-level summary of your domain's health, content, and activity. You can quickly grasp key"
---
...
<Frame>
  <img
    alt="Snippet showing the Overview tab for the B2B Sales Domain"
    lightAlt="Snippet showing the Overview tab for the B2B Sales Domain"
    darkAlt="Snippet showing the Overview tab for the B2B Sales Domain"
    src="/images/new-ui-overview-tab-01.png"
  ...
  <img
    ...
    lightAlt="Snippet showing the Overview tab for the B2B Sales Domain"
    darkAlt="Snippet showing the Overview tab for the B2B Sales Domain"
    src="/dark-img/new-ui-overview-tab-01.png"
...
<Frame>
  <img
    src="/images/new-ui-overview-tab-02.png"
    alt="Show the relationship diagram"
    lightAlt="Show the relationship diagram"
    darkAlt="Show the relationship diagram"
    className="dark:hidden"
  />
  <img
    src="/dark-img/new-ui-overview-tab-02.png"
    alt="Show the relationship diagram"
    lightAlt="Show the relationship diagram"
    darkAlt="Show the relationship diagram"
    className="hidden dark:block"
