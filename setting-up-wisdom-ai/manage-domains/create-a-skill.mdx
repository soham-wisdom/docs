...
keywords: ["skill", "skills", "create a skill"]
og:description: "There are two ways to create a skill: directly through the Skills tab in domain settings, or by using the skill-creator system skill in chat to generate a"
---
