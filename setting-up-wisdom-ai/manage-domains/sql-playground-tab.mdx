...
og:description: "The SQL Playground tab provides an interactive environment for writing and executing SQL queries on the domain’s connected data sources. It allows you to"
---
...
<Frame>
  <img
    src="/images/new-ui-sql-playground.png"
    alt="Sql Playground Tab"
    lightAlt="Sql Playground Tab"
    darkAlt="Sql Playground Tab"
    className="dark:hidden"
  />
  <img
    src="/dark-img/new-ui-sql-playground.png"
    alt="Sql Playground Tab"
    lightAlt="Sql Playground Tab"
    darkAlt="Sql Playground Tab"
