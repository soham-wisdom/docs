...
og:description: "Domains define how WisdomAI accesses data, understands business context, and evaluates the accuracy of its responses. All configuration related to data"
---
...
<Frame>
  <img
    alt="Snippet showing the Overview tab of a Domain"
    src="/dark-img/new-ui-domains-ui-overview2.png"
    lightAlt="Snippet showing the Overview tab of a Domain"
    darkAlt="Snippet showing the Overview tab of a Domain"
    className="hidden dark:block"
  />

  <img
    alt="Snippet showing the Overview tab of a Domain"
    src="/images/new-ui-domains-ui-overview.png"
    lightAlt="Snippet showing the Overview tab of a Domain"
    darkAlt="Snippet showing the Overview tab of a Domain"
