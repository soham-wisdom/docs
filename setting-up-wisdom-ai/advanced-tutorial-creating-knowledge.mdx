...
This concept page, intended for Admin users and Data Administrators, details the three primary methods for creating and curating knowledge to improve AI-powered analytics. The learning objectives are to:
...
To understand these concepts, you should:

- Have Admin/Data Admin access.
- Have completed the [Basic Tutorial](/setting-up-wisdom-ai/basic-tutorial-connect-and-test) to connect data sources and create domains.
