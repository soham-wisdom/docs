...
Natively, business context lives inside the specific Domain where it is created. Because data access permissions are strictly enforced at the Domain level, teams working in separate Domains cannot see or use each other's background context.
...
<Frame>
  <img
    ...
    lightAlt="NEW Add Knowledge Steps"
    darkAlt="NEW Add Knowledge Steps"
    src="/images/access-context-imgv1.png"
  />
</Frame>
