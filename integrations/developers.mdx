...
<CardGroup cols={3}>
  ...
  <Card title="MCP Server" icon="plug" href="/integrations/mcp-server/MCP-Server">
    Connect WisdomAI to Claude Code, Cursor, and any MCP-compatible AI tool.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="I want my AI coding assistant to query WisdomAI data.">
    Use the [MCP Server](/integrations/mcp-server/MCP-Server). It exposes WisdomAI search and agent capabilities as tools in Claude Code, Cursor, and other MCP-compatible hosts.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Server" icon="plug" href="/integrations/mcp-server/MCP-Server">
    Connect your AI coding tools to WisdomAI.
  </Card>
</CardGroup>
