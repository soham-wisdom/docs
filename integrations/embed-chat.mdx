...
The section below describes the steps to configure your embedded chat.
...
In the `conversationId`, add the ID for this specific chat and in the token query param, add the signed `jwt-token` that you generated in step 2.
