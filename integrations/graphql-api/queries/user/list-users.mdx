---
title: "List Users"
og:description: "The listUsers query returns users in a workspace along with their attributes and role assignments. Use it to look up user IDs before calling impersonateUser or"
---
