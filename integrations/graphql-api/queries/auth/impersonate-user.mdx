...
<Warning>
  Never expose your permanent access key in client-side code. Always call this query from your server. See the [embedding overview](/integrations/embedding/embedding) for the secure server-side flow.
</Warning>
