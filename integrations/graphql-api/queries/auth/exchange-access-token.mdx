...
og:description: "The exchangeAccessToken query exchanges a dedicated access key for a JWT token that can be used to authenticate subsequent GraphQL API requests."
---
