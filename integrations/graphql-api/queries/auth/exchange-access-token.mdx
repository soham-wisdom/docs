...
<Warning>
  **Deprecation Notice**: For embedding use cases, use the [Impersonate User](/integrations/graphql-api/queries/auth/impersonate-user) API instead, which provides better security and user context.
</Warning>
