...
- [User](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#user)
- [UserPreferences](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#userpreferences)
- [NotificationPreferences](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#notificationpreferences)
- [Permission](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#permission)

The [Enums](#enums) are:

- [UserRole](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#userrole)
- [UserStatus](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#userstatus)
- [Theme](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#theme)


The [Scalar Types](#scalar-types) are:

- [DateTime](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#datetime)
- [JSON](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#json)
- [ID](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#id)
- [String](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#string)
- [Boolean](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#boolean)
- [Int](https://docs.askwisdom.ai/integrations/graphql-api/objects/user#int)
