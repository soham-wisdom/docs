---
title: "Users"
description: "Objects related to users, authentication, and user management in Wisdom AI."
---
...
<CardGroup cols={2}>
  <Card title="Queries" icon="search" href="/graphql-api/queries">
    Learn how to query user data
  </Card>
  <Card title="Mutations" icon="pen-to-square" href="/graphql-api/mutations">
