...
og:description: "This page describes the results returned from AI function calls, grouped together and including details for each individual function invocation."
---
