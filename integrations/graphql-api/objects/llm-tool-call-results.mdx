...
description: >-
  This page describes the results returned from AI function calls, grouped
  together and including details for each individual function invocation.
keywords:
  - function call output
  - tool result
  - AI function response
  - assistant tool output
  - LLM function results
---
