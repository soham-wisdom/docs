...
<ParamField path="bodyDiff" type="Delta!" required>
  The incremental content changes for the message. See [Delta](/integrations/embeddings/graphql-api/objects/delta).
</ParamField>
...
<ParamField path="sender" type="ChatMessageSender!" required>
  The sender of the message. See [ChatMessageSender](/integrations/embeddings/graphql-api/objects/chat-message-sender).
</ParamField>
...
<CardGroup cols={2}>
  ...
  <Card title="ChatMessageSender Enum" icon="user" href="/integrations/embeddings/graphql-api/objects/chat-message-sender">
