---
title: "LLMToolCalls"
keywords: ["LLM", "LLM tool calls"]
og:description: "This page describes the AI function calls made by the assistant, including details for each individual call and their associated arguments."
---
