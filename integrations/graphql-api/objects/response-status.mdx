...
og:description: "ResponseStatus is returned by mutations to indicate whether the operation succeeded. It is a distinct type from the UserStatus enum — mutation responses use"
---
