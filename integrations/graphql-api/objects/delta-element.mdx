---
title: "DeltaElement"
description: "Content elements that can be inserted in operations"
---
...
<CardGroup cols={2}>
  <Card title="Operation Schema" icon="settings" href="/integrations/graphql-api/objects/operation">
  ...
  <Card title="TextArtifact Schema" icon="document-text" href="/integrations/graphql-api/objects/text-artifact">
    Rich text content with references
  </Card>
  <Card title="LLMToolCalls Schema" icon="cog" href="/integrations/graphql-api/objects/llm-tool-calls">
    AI function calls
  </Card>
</CardGroup>
