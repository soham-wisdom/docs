---
title: "DomainModel"
description: "Schema for domain objects that organize related data sources"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Domain Queries" icon="search" href="/integrations/graphql-api/queries/domain">
    Query domain information and metadata
  </Card>
