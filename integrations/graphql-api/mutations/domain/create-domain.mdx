...
Returns a `DomainModel` object representing the newly created domain. See [DomainModel](/integrations/embeddings/graphql-api/objects/domain-model) for the schema.
