...
og:description: "The dataSourcesUpdate mutation updates the data sources configuration for an existing domain by specifying tables and their relationships. This operation"
---
