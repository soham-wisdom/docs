...
og:description: "The impersonateUser mutation exchanges a permanent access key for a short-lived JWT token that authenticates subsequent requests as a specific user. This is"
---
