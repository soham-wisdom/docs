...
<ParamField path="roleAssignments" type="[RoleAssignmentInput!]">
  Role assignments for the new users. Each entry specifies a `roleId` and `scopes`. See [RoleAssignmentInput](/integrations/graphql-api/objects/role-assignment-input).
