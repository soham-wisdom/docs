...
og:description: "The connectionRefresh mutation triggers an asynchronous job that refreshes the metadata for a data warehouse connection. Specifically, it refreshes the list of"
---
