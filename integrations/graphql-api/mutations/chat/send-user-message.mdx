...
og:description: "The sendUserMessage mutation sends a user's message or question to an existing conversation, triggering AI-powered analysis and response generation."
---
