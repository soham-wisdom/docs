...
description: >-
  The sendUserMessage mutation sends a user's message or question to an existing
  conversation, triggering AI-powered analysis and response generation.
keywords:
  - sendUserMessage
  - ask a question via API
  - send a chat message
  - GraphQL chat mutation
---
