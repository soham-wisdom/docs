...
og:description: "The addScopeRoleAssignmentsForSharing mutation grants access to a specific resource (like a Dashboard) by assigning roles to users. This allows you to share"
---
