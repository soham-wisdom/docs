...
| Field | Type | Required |
|-------|------|----------|
| `dashboard` | `DashboardInput` | Required — see [DashboardInput](/integrations/graphql-api/objects/dashboard-input) |
| `widgets` | `[DashboardWidgetInput!]` | Required — see [DashboardWidgetInput](/integrations/graphql-api/objects/dashboard-widget-input) |

## Response

| Field | Type | Description |
|-------|------|-------------|
| `id` | `ID` | Unique dashboard ID |
| `name` | `String` | Dashboard name |
| `description` | `String` | Dashboard description |
| `widgets` | `[DashboardWidget]` | Widget list with IDs and layout positions |
| `accessLevel` | `String` | Access level of the dashboard |

See [Dashboard](/integrations/graphql-api/objects/dashboard) for the full schema.
...
| 400 | Bad Request | Invalid `DashboardInput` or `DashboardWidgetInput` |
