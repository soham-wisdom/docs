...
<ParamField path="dashboard" type="DashboardInput!" required>
  Input object containing the dashboard configuration. See [DashboardInput](/integrations/embeddings/graphql-api/objects/dashboard-input).
</ParamField>

<ParamField path="widgets" type="[DashboardWidgetInput!]!" required>
  Array of widget configurations to include in the new dashboard. See [DashboardWidgetInput](/integrations/embeddings/graphql-api/objects/dashboard-widget-input).
</ParamField>

## Response

Returns the newly created `Dashboard` object with all properties populated. See [Dashboard](/integrations/embeddings/graphql-api/objects/dashboard) for the schema.
...
<CardGroup cols={2}>
  ...
  <Card title="DashboardInput Object" icon="folder" href="/integrations/embeddings/graphql-api/objects/dashboard-input">
