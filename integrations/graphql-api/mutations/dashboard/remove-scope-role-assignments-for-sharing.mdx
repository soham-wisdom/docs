...
og:description: "The removeScopeRoleAssignmentsForSharing mutation removes access to a specific resource (like a Dashboard) by revoking roles from users. This allows you to"
---
