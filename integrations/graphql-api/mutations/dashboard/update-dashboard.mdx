...
<ParamField path="dashboard" type="DashboardInput" required>
  Input object containing the updated dashboard properties. See [DashboardInput](/integrations/embeddings/graphql-api/objects/dashboard-input).
</ParamField>

## Response

Returns the updated `Dashboard` object with all properties populated. See [Dashboard](/integrations/embeddings/graphql-api/objects/dashboard) for the schema.
