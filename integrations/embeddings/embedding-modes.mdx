...
og:description: "WisdomAI supports four embed paths. Each path renders a different slice of the WisdomAI interface inside your iframe. All paths require a valid JWT passed as"
---
