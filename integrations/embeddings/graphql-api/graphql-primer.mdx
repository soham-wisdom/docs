...
See [Error handling](/integrations/embeddings/graphql-api/GraphQL-API#error-handling) for details.
...
<CardGroup cols={2}>
  <Card title="GraphQL API overview" icon="code" href="/integrations/embeddings/graphql-api/GraphQL-API">
    Endpoint, authentication, and error handling
  </Card>
  <Card title="User management" icon="users" href="/integrations/embeddings/graphql-api/user-management">
