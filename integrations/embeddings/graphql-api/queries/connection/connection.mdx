...
Returns a `Connection` object containing connection details and status information. See [Connection](/integrations/embeddings/graphql-api/objects/connection) schema.
...
<CardGroup cols={2}>
  ...
  <Card title="Connection Schema" icon="database" href="/integrations/embeddings/graphql-api/objects/connection">
