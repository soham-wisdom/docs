...
<ParamField path="scope" type="DashboardScope!" required>
  The access level to filter dashboards by. See [DashboardScope](/integrations/embeddings/graphql-api/objects/dashboard-scope).
</ParamField>
...
Returns a `DashboardsResponse` object containing a list of accessible dashboards. See [DashboardsResponse](/integrations/embeddings/graphql-api/objects/dashboards-response) for the schema.
...
<CardGroup cols={2}>
  <Card title="Dashboard Query" icon="search" href="/integrations/embeddings/graphql-api/queries/dashboard/dashboard">
  ...
  <Card title="DashboardsResponse Object" icon="folder" href="/integrations/embeddings/graphql-api/objects/dashboards-response">
