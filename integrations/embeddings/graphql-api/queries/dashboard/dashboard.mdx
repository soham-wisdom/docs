...
<ParamField path="scope" type="DashboardScope!" required>
  The access level required for the dashboard. See [DashboardScope](/integrations/embeddings/graphql-api/objects/dashboard-scope).
</ParamField>
...
Returns a `Dashboard` object containing the complete dashboard configuration and metadata. See [Dashboard](/integrations/embeddings/graphql-api/objects/dashboard) for the schema.
