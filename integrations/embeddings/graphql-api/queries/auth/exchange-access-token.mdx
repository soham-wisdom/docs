...
<Warning>
  **Deprecation Notice**\
  For embedding use cases, use the [Impersonate User](/integrations/embeddings/graphql-api/queries/auth/impersonate-user) API instead, which provides better security and user context.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Impersonate User" icon="user" href="/integrations/embeddings/graphql-api/queries/auth/impersonate-user">
