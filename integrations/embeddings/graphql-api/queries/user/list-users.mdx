...
The `listUsers` query returns users in a workspace along with their attributes and role assignments. Use it to look up user IDs before calling [impersonateUser](/integrations/embeddings/graphql-api/mutations/auth/impersonate-user) or [setUserAttributes](/integrations/embeddings/graphql-api/mutations/user/set-user-attributes).
