...
<ParamField path="status" type="JobStatus!" required>
  Job execution status for connection operations like metadata refresh. See [JobStatus](/integrations/embeddings/graphql-api/objects/job-status).
</ParamField>
...
<CardGroup cols={2}>
  <Card title="Connection Queries" icon="magnifying-glass" href="/integrations/embeddings/graphql-api/queries/connection/connection">
  ...
  <Card title="Refresh Connection" icon="arrows-rotate" href="/integrations/embeddings/graphql-api/mutations/connection/refresh-connection">
    Trigger connection metadata refresh
  </Card>
  <Card title="Domain Objects" icon="folder" href="/integrations/embeddings/graphql-api/objects/domain-model">
