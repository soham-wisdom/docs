...
<ParamField path="connection" type="Connection">
  Connection details for accessing this database. See [Connection](/integrations/embeddings/graphql-api/objects/connection).
</ParamField>
...
<CardGroup cols={2}>
  ...
  <Card title="Connection Objects" icon="link" href="/integrations/embeddings/graphql-api/objects/connection">
    Learn about connection schema and properties
  </Card>
  <Card title="JobStatus Schema" icon="clock" href="/integrations/embeddings/graphql-api/objects/job-status">
