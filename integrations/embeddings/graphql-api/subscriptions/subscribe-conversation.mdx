...
Returns an array of `ConversationUpdateOneOf` objects representing conversation updates. See [ConversationUpdateOneOf](/integrations/embeddings/graphql-api/objects/conversation-update-one-of) for the schema.
...
<CardGroup cols={2}>
  <Card title="ConversationUpdateOneOf Schema" icon="cube" href="/integrations/embeddings/graphql-api/objects/conversation-update-one-of">
