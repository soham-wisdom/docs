...
<ParamField path="roleAssignments" type="[ScopeRoleAssignmentInput!]">
  Role assignments for the new users. Each entry specifies a `role` and a `scopeId`. See [ScopeRoleAssignmentInput](/integrations/embeddings/graphql-api/objects/scope-role-assignment-input).
