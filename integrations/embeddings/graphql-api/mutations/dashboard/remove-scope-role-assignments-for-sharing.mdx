...
<ParamField path="scopeRoleAssignments" type="[ScopeRoleAssignmentInput!]!" required>
  Array of user-role assignments to remove. See [ScopeRoleAssignmentInput](/integrations/embeddings/graphql-api/objects/scope-role-assignment-input) for the input structure.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="Add Scope Role Assignments for Sharing" icon="user-plus" href="/integrations/embeddings/graphql-api/mutations/dashboard/add-scope-role-assignments-for-sharing">
    Grant sharing access to users
  </Card>
  <Card title="Delete Dashboard" icon="trash" href="/integrations/embeddings/graphql-api/mutations/dashboard/delete-dashboard">
