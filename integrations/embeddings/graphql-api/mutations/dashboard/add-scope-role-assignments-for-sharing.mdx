...
<ParamField path="scopeRoleAssignments" type="[ScopeRoleAssignmentInput!]!" required>
  Array of user-role assignments defining who gets access and what level of access they receive. See [ScopeRoleAssignmentInput](/integrations/embeddings/graphql-api/objects/scope-role-assignment-input) for the input structure.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="Remove Scope Role Assignments for Sharing" icon="user-minus" href="/integrations/embeddings/graphql-api/mutations/dashboard/remove-scope-role-assignments-for-sharing">
