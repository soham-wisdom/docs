...
<ParamField path="tables" type="[TableInput!]!" required>
  List of tables to include in the domain. See [TableInput](/integrations/embeddings/graphql-api/objects/table-input).
</ParamField>

<ParamField path="joins" type="[JoinInput!]">
  List of join relationships between tables. See [JoinInput](/integrations/embeddings/graphql-api/objects/join-input).
</ParamField>
...
<CardGroup cols={2}>
  ...
  <Card title="JoinInput Schema" icon="link" href="/integrations/embeddings/graphql-api/objects/join-input">
