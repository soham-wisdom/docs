...
This guide outlines the process for embedding WisdomAI Chat into your application. Before proceeding, ensure you've reviewed the [main embedding documentation](/integrations/embeddings/embedding) for authentication setup and security requirements.
