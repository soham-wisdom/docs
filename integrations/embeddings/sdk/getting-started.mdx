...
This guide covers installation, authentication, and theming.
...
<CardGroup cols={2}>
  ...
  <Card title="Embedding modes" icon="diagram-project" href="integrations/embeddings/embedding-modes">
    Embed WisdomAI chat and dashboards into your application, without WisdomAI branding or navigation, but with all core capabilities intact.
  </Card>
</CardGroup>