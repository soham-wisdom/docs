...
og:description: "The SDK uses a two-package auth model: @wisdomai/node runs on your backend and mints short-lived tokens; WisdomProvider runs in the browser and consumes them."
---
