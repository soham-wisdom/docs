...
keywords: ["SDK getting started", "getting started with SDK", "SDK setup"]
og:description: "Get a live, interactive WisdomAI dashboard rendering in your React app. You'll install the packages, add a small backend endpoint that mints a short-lived"
---
