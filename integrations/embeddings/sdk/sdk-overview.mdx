...
- **Decoupled global filters**: `WisdomGlobalFilters` can live anywhere in the host layout, independent of the dashboard component
- **Widget surfaces**: Table readability, scrolling, and pagination work correctly in embedded contexts
