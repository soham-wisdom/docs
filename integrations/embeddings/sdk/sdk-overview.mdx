...
<AccordionGroup>
  ...
  <Accordion title="Which version includes Chat and DashChat?">
    Both ship in `@wisdomai/react@0.0.12`, currently published on the `next` npm tag (`npm install @wisdomai/react@next`).
  </Accordion>
</AccordionGroup>
