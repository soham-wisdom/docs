...
- [**Quickstart**](): Install, wire up auth, and render your first dashboard.
- [**Components**](): Embed dashboards, single widgets, custom widget cards, and filters.
- [**Authentication**](): The `@wisdomai/node` token exchange, `WisdomProvider`, and per-user (multi-tenant) tokens.
