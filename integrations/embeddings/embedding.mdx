...
<Steps>
  ...
  <Step title="Set user attributes (optional)" titleSize="h3">
    ...
    See [User Attributes](/integrations/embeddings/user-management/user-attributes) for details on how attributes work and how to set them.
  </Step>
  <Step title="Impersonate the user to get a JWT" titleSize="h3">
    ...
    See [Impersonate User](/integrations/embeddings/graphql-api/mutations/auth/impersonate-user) for the full API reference, including information on passing transient attributes.
  </Step>
