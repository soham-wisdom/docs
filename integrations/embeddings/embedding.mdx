...
<Steps>
  <Step title="Get your access token" titleSize="h3">
    Contact `support@askwisdom.ai` to receive your Access Key. This is a permanent credential, not a JWT or session token. It authenticates your server to the WisdomAI API and grants impersonation permissions. It does not expire and must be kept secret.
  </Step>
