...
<Steps>
  <Step title="Get your access token" titleSize="h3">
    Every WisdomAI user can create and manage their own API keys. To obtain your dedicated access key, follow the steps in [this article](/settings/api-keys#api-keys).
