...
1. In your Google Sheet, go to **Wisdom AI** \> **Configure Account** from the menu bar. <img src="/images/googleSheets1.png" />
...
4. Go to **Wisdom AI** \> **Test Connection** to verify everything works. <img src="/images/googleSheets2.png" />
