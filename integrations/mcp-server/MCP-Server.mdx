...
<Warning>
  ...
  - If you log in via **{ACCOUNT}.[wisdom.ai](http://wisdom.ai)**, use `https://{ACCOUNT}.wisdom.ai/mcp`
  - If you log in via **{ACCOUNT}.[askwisdom.ai](http://askwisdom.ai)**, use `https://{ACCOUNT}.askwisdom.ai/mcp`
</Warning>
