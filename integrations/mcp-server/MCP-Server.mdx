...
WisdomAI provides a [Model Knowledge Protocol (MCP)](https://modelcontextprotocol.io) server that enables direct integration with MCP-compatible clients. The MCP server exposes WisdomAI's powerful data analysis capabilities through standardized tool interfaces.
