...
The server implements the [MCP specification](https://modelcontextprotocol.io/specification). All responses include structured content that can be rendered as text, tables, or interactive charts.
