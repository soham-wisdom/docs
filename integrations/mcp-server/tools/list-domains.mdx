...
og:description: "The list-domains tool retrieves all domains accessible to the authenticated user. This tool is essential for discovering available data domains before making"
---
