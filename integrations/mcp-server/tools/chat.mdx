---
title: "Chat Tool"
og:description: "The chat tool is the primary interface for interacting with WisdomAI's powerful data analysis capabilities. It accepts natural language questions and returns"
---
