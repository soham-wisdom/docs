...
### Streaming Visualization Request
...
// Notification 3 (final partial before complete)
{
  "jsonrpc": "2.0",
  "method": "chat/update",
  "params": {
...
<CardGroup cols={2}>
  <Card title="MCP Notifications" icon="bell" href="https://modelcontextprotocol.io/specification/basic/notifications">
    Official MCP notifications specification
  </Card>
