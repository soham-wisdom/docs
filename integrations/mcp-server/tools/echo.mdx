...
<CardGroup cols={3}>
  <Card title="List Domains Tool" icon="list" href="/integrations/embeddings/mcp-server/tools/list-domains">
    Discover available domains for querying
  </Card>
  <Card title="Chat Tool" icon="message" href="/integrations/embeddings/mcp-server/tools/chat">
    Primary tool for data analysis and natural language querying
  </Card>
  <Card title="MCP Server Overview" icon="server" href="/integrations/embeddings/mcp-server/MCP-Server">
