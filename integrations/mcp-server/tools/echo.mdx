---
title: "Echo Tool"
og:description: "The echo tool is a simple testing utility that echoes back the input message with an \"Echo: \" prefix. This tool is primarily used for testing MCP server"
---
