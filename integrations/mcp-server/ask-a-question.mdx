...
Asking through MCP is an asynchronous conversation flow: your client starts a chat, checks for the result, and continues when WisdomAI needs clarification or a follow-up. This guide walks through the tool sequence and response states for anyone building directly against the MCP server.
...
The diagram shows how a question moves from a new conversation through polling, clarification, completion, and follow-up.
