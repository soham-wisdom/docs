...
title: "Roles"
hidden: true
og:description: "Roles control what a user can see and do within a WisdomAI workspace. When provisioning embedded users, pass a role ID in roleAssignments to grant the"
---
...
<Note>
  For the full permission breakdown across all roles, see [RBAC for Embedded Users](/integrations/user-management/rbac).
</Note>
