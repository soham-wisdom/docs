...
og:description: "User attributes are key-value pairs attached to a user that control how WisdomAI filters and personalizes data for their session. They are used for:"
---
