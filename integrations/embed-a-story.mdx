...
This guide outlines the process for securely embedding a WisdomAI Story into your application. The process involves using a permanent **Access Token** to generate temporary **JSON Web Tokens (JWTs)** that authorize the display of an embedded story.
