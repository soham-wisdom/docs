...
1. Request a permanent Access Token
2. Generate temporary JSON Web Tokens (JWTs)
3. Embedded the story in your web application

The section below will provide more details on these steps.
