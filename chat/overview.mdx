---
title: "Chat 2.0"
keywords: ["chat", "chat overview", "chat v2"]
boost: 15
---
...
| **Expert** | Highest reasoning, for the hardest questions and complex analysis. Expect it to take longer, go deeper, and often produce a full report. See [Expert Mode](/chat/expert-mode) for a deeper walkthrough. |

![Image showing the choose mode dropdown](/images/choose-mode.png)
