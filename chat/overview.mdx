---
title: "Chat 2.0"
keywords: ["chat", "chat overview", "chat v2", "PDF", "DOCX"]
boost: 15
---
...
<img
  src="/images/choose-mode.png"
  alt="Image showing the choose mode dropdown"
  lightAlt="Image showing the choose mode dropdown"
  darkAlt="Image showing the choose mode dropdown"
  className="dark:hidden"
/>
<img
  src="/dark-img/choose-mode.png"
  alt="Image showing the choose mode dropdown"
  lightAlt="Image showing the choose mode dropdown"
  darkAlt="Image showing the choose mode dropdown"
...
## Export reports via PDF, DOCX or share a link
