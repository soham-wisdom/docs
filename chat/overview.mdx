...
- **Tables** support instant filters, so you can narrow a result in place without re-asking.
...
- **Attach files** from the **\+** button: spreadsheets and CSVs, PDFs, images, and most text formats. Ask questions across them together with your connected data. See [Use File Attachments in Chat](#).
...
- Type **/** to insert a skill your team has defined for recurring analysis patterns.
...
- **Add to dashboard** pins the result where your team will see it refreshed. See [Turn Answers into Dashboards](#).
