...
description: "WisdomAI"
keywords: ["privacy policy", "privacy", "GDPR", "compliance", "SOC 2", "data privacy"]
og:description: "WisdomAI, Inc. (\"WisdomAI\", \"we\", \"our\") is committed to maintaining the privacy of its users (\"user\", \"you\"). The following information describes how WisdomAI"
---

WisdomAI, Inc. ("WisdomAI", "we", "our") is committed to maintaining the privacy of its users ("user", "you"). The following information describes how WisdomAI collects and processes information about you when you use our website (the "Website") and Platform (as defined below).
