...
og:description: "This guide provides a step-by-step walkthrough for using an entitlements table in your data warehouse to manage complex, centralized Row-Level Security (RLS)"
---
...
- You should understand the concept of an entitlements table. See [**Understanding Row-Level Security**](/manage-account/row-level-access-control/understanding-row-level-security).
- You should be familiar with the basic RLS configuration screen. See [**How to Configure Row-Level Security**](/manage-account/row-level-access-control/row-level-access-control).
