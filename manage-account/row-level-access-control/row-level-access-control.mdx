...
For a detailed explanation of RLS concepts, functions, and best practices, please see our [**Understanding Row-Level Security**](https://www.google.com/search?q=/row-level-security) guide.
...
1. In your WisdomAI domain, go to the **Tabular Uploads** tab to see the list of tables.
...
4. The **Row-Level Security Configuration** screen opens.
...
3. You can use Wisdom’s built-in functions for dynamic, user-aware filtering. For a complete list of functions and examples, see [**Dynamic Filters with Custom Functions**](https://www.google.com/search?q=/row-level-security%23dynamic-filters-with-custom-functions) in our guide to understanding RLS.
