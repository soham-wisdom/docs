...
For a detailed explanation of RLS concepts, functions, and best practices, please see our [**Understanding Row-Level Security**](/understanding-row-level-security) guide.
...
3. You can use Wisdom’s built-in functions for dynamic, user-aware filtering. For a complete list of functions and examples, see [**Dynamic Filters with Custom Functions**](/understanding-row-level-security) in our guide to understanding RLS.
