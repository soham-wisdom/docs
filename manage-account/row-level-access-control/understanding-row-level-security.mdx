...
og:description: "Row-Level Security (RLS) is a data security feature that filters data seamlessly at the row level, ensuring users can only see the data they are permitted to"
---
...
<CardGroup cols={2}>
  <Card title="How to Configure Row-Level Security" icon="user-shield" href="/manage-account/row-level-access-control/row-level-access-control">
    Learn to restrict data access for specific users or roles at the row level.
  </Card>
  <Card title="User Management" icon="users" href="/manage-account/users-management">
