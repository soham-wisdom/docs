...
keywords: ["SSO", "SAML", "SCIM", "IdP", "identity provider", "claims", "OAuth"]
og:description: "Once users are provisioned via SSO, you can automate their permission levels by mapping Identity Provider (IdP) data to WisdomAI roles."
---
