...
keywords: ["access control", "access controls", "permissions", "custom roles", "RBAC", "role", "roles"]
boost: 5
og:description: "We use role-based access control (RBAC) to ensure users have the permissions they need for their jobs. In an RBAC model, each user is assigned one or more"
---
