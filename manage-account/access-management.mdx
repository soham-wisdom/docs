...
Explorers are data consumers. They use WisdomAI to explore, analyze, and interact with data through dashboards and chat — within the Domains they have been given access to. They can:
