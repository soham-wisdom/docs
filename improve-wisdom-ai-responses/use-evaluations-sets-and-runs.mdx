...
**Score:** Reflects the result of the completed evaluation. It tells you how many conversations passed based on predefined criteria.

<Tip>
  The score criteria depend on how the evaluation was configured, such as specific SQL matches which are set in the evaluation set details.
</Tip>


### View Evaluation Report

When you click on the "View Report" option, you will be taken to an **Evaluation Report**. This report offers comprehensive details about how an evaluation run performed. Here's a breakdown of the information you'll find:
...
- **Soft Match:** This score indicates the overall performance of the evaluation. It's displayed as a fraction (e.g., "0 / 4"), showing how many of the evaluation criteria were successfully met out of the total.
- \*\*Individual Session Details: \*\*The report organizes the evaluation results by individual sessions or queries.

![View Report 01 Gi](/images/view-report-01.gif)
...
- **Evaluation Details:** This section, which you can expand, provides specific insights into how the session's evaluation was conducted and its outcome:
  ...
  - **Automated Score:** The score automatically assigned by the system for this evaluation.
  - **Ground Truth:** This section explains the expected or correct outcome of the query. It often includes details about the relevant domain tables (e.g., "Table SalesOpportunities is not part of the domain tables Account, Contact, Contract, Opportunity, Stage, User, UserQuota, UserRole."), helping you understand why the system's output might differ from the expected result.
...
- **Conversation:** You can expand this section to review the entire conversational exchange related to that specific session. This includes:
  ...
  - The complete conversational interaction, showing your prompt and the system's response.
...
By utilizing the "View Report" option, you gain comprehensive visibility into each evaluated query, empowering you to understand the system's processing, verify generated results, and review the underlying conversational logic.
