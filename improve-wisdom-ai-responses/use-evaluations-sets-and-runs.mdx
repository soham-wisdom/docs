...
og:description: "This article describes the concepts of Evaluation Sets and Evaluation Runs, which are tools used to test and validate your AI's domain performance."
---
...
<img
  ...
  src="/images/evaluation-inspec-1.gif"
  className="dark:hidden"
/>
<img
  alt="Gif showing the Session Details"
...
<CardGroup cols={2}>
  ...
  <Card title="Quickstart: Connect and Test" icon="rocket" href="/setting-up-wisdom-ai/basic-tutorial-connect-and-test">
