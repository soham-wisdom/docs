...
This article describes the fundamental concepts of Evaluation Sets and Evaluation Runs, which are tools used to test and validate your AI's domain performance.

## Evaluation Sets

Evaluation Sets allow you to create specific sets of prompts that simulate user interactions. You can provide expected SQL outputs alongside these prompts. This allows for a direct comparison to see how accurately the AI converts natural language into database queries.
