...
4. Fill out the **Add Evaluation** Form, providing a set **Name** and presenting a natural language query. Optionally, you can import CSV and also ground truth SQL.
   <Tip>
     The array you provide defines how many conversations will be created. Each _top-level element_ in the array represents a conversation: ✔ If it's a string or an object → You get a single-message conversation\
     ✔ If it's an array → You create a multi-message conversation For example, this input:\
     `["prompt1", ["prompt2.1", "prompt2.2"], "prompt3"]`\
     creates **3 conversations**: the first and third with one message each, and the second with two messages. You can structure the arrays in any way, mixing single and multi-message conversations as required.
   </Tip>
...
<img
  ...
  src="/images/view-report-01v2.gif"
  className="dark:hidden"
/>
<img
  alt="View Report 01v2 Gi"
  lightAlt="View Report 01v2 Gi"
  darkAlt="View Report 01v2 Gi"
  src="/dark-img/view-report-01v2.gif"
  className="hidden dark:block"
/>
...
<img
  ...
  src="/images/session-details.gif"
  className="dark:hidden"
/>
<img
  alt="Gif showing the Session Details"
...
<img
  ...
  src="/images/conversation-detailed.gif"
  className="dark:hidden"
/>
<img
  alt="Gif showing the Conversation in Detail"
  lightAlt="Gif showing the Conversation in Detail"
  darkAlt="Gif showing the Conversation in Detail"
  src="/dark-img/conversation-detailed.gif"
  className="hidden dark:block"
/>
