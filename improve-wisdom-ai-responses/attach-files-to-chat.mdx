---
title: "Using File Attachments in Chat"
og:description: "You can attach a file to your WisdomAI chat to provide additional context for the session. This feature enables WisdomAI to use the information in the file to"
---
...
<Check>
  ...
  - These files can also be used as data sources. To learn how to upload files to a Domain, read [**Quickstart: Connect and Test \> Upload CSV files**](/setting-up-wisdom-ai/basic-tutorial-connect-and-test)**.**
</Check>
