...
<img
  alt="Dashboards Editor showing the Overview section with summary widgets and filters for refining insights"
  lightAlt="Dashboards Editor showing the Overview section with summary widgets and filters for refining insights"
  darkAlt="Dashboards Editor showing the Overview section with summary widgets and filters for refining insights"
  src="/images/new-ui-stories-editor-overview-section-v2.png"
...
<img
  ...
  lightAlt="Dashboards Editor showing the Overview section with summary widgets and filters for refining insights"
  darkAlt="Dashboards Editor showing the Overview section with summary widgets and filters for refining insights"
  src="/dark-img/new-ui-stories-editor-overview-section-v2.png"
...
<img
  alt="Example of a Dashboard ready for stakeholder sign-off with options to share and review feedback"
  lightAlt="Example of a Dashboard ready for stakeholder sign-off with options to share and review feedback"
  darkAlt="Example of a Dashboard ready for stakeholder sign-off with options to share and review feedback"
  src="/images/get-sign-off.png"
  className="dark:hidden"
/>
<img
  alt="Example of a Dashboard ready for stakeholder sign-off with options to share and review feedback"
...
<img
  alt="Share options panel in a Dashboard, showing settings to manage access and sharing links"
  lightAlt="Share options panel in a Dashboard, showing settings to manage access and sharing links"
  darkAlt="Share options panel in a Dashboard, showing settings to manage access and sharing links"
  src="/images/new-ui-share-story-build-dashb2.png"
  className="dark:hidden"
/>
<img
  alt="Share options panel in a Dashboard, showing settings to manage access and sharing links"
  lightAlt="Share options panel in a Dashboard, showing settings to manage access and sharing links"
  darkAlt="Share options panel in a Dashboard, showing settings to manage access and sharing links"
  src="/dark-img/new-ui-share-story-build-dashb2.png"
  className="hidden dark:block"
/>

- If you would like to schedule Dashboard updates and receive notifications, check out the [**Subscribe to a Dashboard**](/using-wisdom-ai-everyday/schedule-dashboards-notifications) guide.

<img
  alt="Scheduling options in a Dashboard for setting automated updates and notifications"
  lightAlt="Scheduling options in a Dashboard for setting automated updates and notifications"
  darkAlt="Scheduling options in a Dashboard for setting automated updates and notifications"
  src="/images/subscribe-the-story-build-dashb.png"
  className="dark:hidden"
/>
<img
  alt="Scheduling options in a Dashboard for setting automated updates and notifications"
  lightAlt="Scheduling options in a Dashboard for setting automated updates and notifications"
  darkAlt="Scheduling options in a Dashboard for setting automated updates and notifications"
  src="/dark-img/subscribe-the-story-build-dashb.png"
  className="hidden dark:block"
/>
...
<CardGroup cols={3}>
  ...
  <Card title="Schedule Dashboard Notifications" icon="calendar-days" href="/using-wisdom-ai-everyday/schedule-dashboards-notifications">
