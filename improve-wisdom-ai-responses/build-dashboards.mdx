...
- To learn how to share your Dashboard and manage access permissions, see the [**Share Dashboards and Set Access Control**](/using-wisdom-ai-everyday/share-dashboards-and-set-access-control) article. <img src="/images/share-story-build-dashb.png" alt="Share options panel in a Dashboard, showing settings to manage access and sharing links" />
- If you would like to schedule Dashboard updates and receive notifications, check out the [**Schedule Dashboard Notifications**](/using-wisdom-ai-everyday/schedule-dashboards-notifications) guide. <img src="/images/schedule-the-story-build-dashb.png" alt="Scheduling options in a Dashboard for setting automated updates and notifications" lightAlt="Scheduling options in a Dashboard for setting automated updates and notifications" darkAlt="Scheduling options in a Dashboard for setting automated updates and notifications" />
