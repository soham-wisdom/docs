...
3. **Configure Your Metric**. In the Add a Metric modal window that opens, you will be prompted to provide the following information:
   ...
   - **Calculation Method:** Select how the metric will be defined. The options include:
     ...
     - **Explain SQL in English** _(Beta)_ Describe your desired SQL calculation in plain English and click on **Test** _(a previous step before saving your result)_. The system will attempt to generate the corresponding SQL.
