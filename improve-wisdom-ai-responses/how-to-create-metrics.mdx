...
<Frame>
  <img
    alt="Image showing te Add Metric option"
    lightAlt="Image showing te Add Metric option"
    darkAlt="Image showing te Add Metric option"
    src="/images/new-ui-add-metric.png"
  ...
  <img
    ...
    lightAlt="Image showing te Add Metric option"
    darkAlt="Image showing te Add Metric option"
    src="/dark-img/new-ui-add-metric.png"
...
5. Optionally, use the **Describe in English** field on the left to describe how you want the metric to be calculated in plain language (e.g., "Average Deal Value is the sum of deal amounts where status equals 'won' divided by the total number of won deals"). Then click Generate to automatically produce the SQL.
6. Once you have configured your metric, click **Save** to add it to your Domain's metrics list.

<img
  alt="Snippet of the Add a Metric modal showing the name, SQL expression, and Advanced options."
  lightAlt="Snippet of the Add a Metric modal showing the name, SQL expression, and Advanced options."
  darkAlt="Snippet of the Add a Metric modal showing the name, SQL expression, and Advanced options."
  src="/images/new-ui-add-metric-02-1-1.png"
  className="dark:hidden"
/>
<img
  alt="Snippet of the Add a Metric modal showing the name, SQL expression, and Advanced options."
  lightAlt="Snippet of the Add a Metric modal showing the name, SQL expression, and Advanced options."
  darkAlt="Snippet of the Add a Metric modal showing the name, SQL expression, and Advanced options."
  src="/dark-img/new-ui-add-metric-02-1-1.png"
  className="hidden dark:block"
/>
...
| **Win\_Rate** | Ratio of the sum of amounts for closed won opportunities to the sum of quantities for closed won and closed loss opportunities. | _(Specific SQL would be defined in the system)_ | Automatic |
