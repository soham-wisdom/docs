...
og:description: "Metrics are numeric, quantitative values that can be measured to assess and track business performance. They help you identify trends to make informed"
---
...
<CardGroup cols={2}>
  ...
  <Card icon="rocket" href="/setting-up-wisdom-ai/basic-tutorial-connect-and-test" title="Quickstart: Connect and Test">
