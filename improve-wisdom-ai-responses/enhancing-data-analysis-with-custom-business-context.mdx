---
title: "Enhancing Data Analysis with Custom Business Knowledge"
---
...
<img
  src="/images/2025-07-17_17-09-27.gif"
  alt="Gif showing the first query and the answer without context"
  lightAlt="Gif showing the first query and the answer without context"
  darkAlt="Gif showing the first query and the answer without context"
  className="dark:hidden"
/>
<img
  src="/images/first-query-and-answer-without-context.gif"
  alt="Gif showing the first query and the answer without context"
  lightAlt="Gif showing the first query and the answer without context"
  darkAlt="Gif showing the first query and the answer without context"
...
<img
  alt="Snippet showing the Knowledge page completed with business-specific data"
  lightAlt="Snippet showing the Knowledge page completed with business-specific data"
  darkAlt="Snippet showing the Knowledge page completed with business-specific data"
  src="/images/new-ui-context-knowledge.png"
  className="dark:hidden"
/>
<img
  alt="Snippet showing the Knowledge page completed with business-specific data"
  lightAlt="Snippet showing the Knowledge page completed with business-specific data"
  darkAlt="Snippet showing the Knowledge page completed with business-specific data"
  src="/dark-img/new-ui-context-knowledge.png"
  className="hidden dark:block"
/>
...
<img
  src="/images/2025-07-17_17-21-24.gif"
  alt="Gif showing the same query and the answer with context"
  lightAlt="Gif showing the same query and the answer with context"
  darkAlt="Gif showing the same query and the answer with context"
  className="dark:hidden"
/>
<img
  src="/images/same-query-and-answer.gif"
  alt="Gif showing the same query and the answer with context"
  lightAlt="Gif showing the same query and the answer with context"
  darkAlt="Gif showing the same query and the answer with context"
  className="hidden dark:block"
...
<img
  src="/images/new-ui-example-JSON-Knowledge-light.gif"
  alt="Gif showing an example JSON Knowledge"
  lightAlt="Gif showing an example JSON Knowledge"
  darkAlt="Gif showing an example JSON Knowledge"
  className="dark:hidden"
/>
<img
  src="/images/example-JSON-Knowledge.gif"
  alt="Gif showing an example JSON Knowledge"
  lightAlt="Gif showing an example JSON Knowledge"
  darkAlt="Gif showing an example JSON Knowledge"
  className="hidden dark:block"
...
<img
  src="/images/2025-07-17_17-42-43.gif"
  alt="A gif showing the result calculated successfully after using a JSON context to parse unstructured text"
  lightAlt="A gif showing the result calculated successfully after using a JSON context to parse unstructured text"
  darkAlt="A gif showing the result calculated successfully after using a JSON context to parse unstructured text"
  className="dark:hidden"
/>
<img
  src="/images/result-calculated-successfully.gif"
  alt="A gif showing the result calculated successfully after using a JSON context to parse unstructured text"
  lightAlt="A gif showing the result calculated successfully after using a JSON context to parse unstructured text"
  darkAlt="A gif showing the result calculated successfully after using a JSON context to parse unstructured text"
  className="hidden dark:block"
