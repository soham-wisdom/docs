...
2. View **Chat Log entries**. The Chat Log displays a tabular view of interactions, with each row representing a chat entry and providing key metadata:
   ...
   <Tabs>
     ...
     <Tab title="Responses">
       Displays the number of responses within a chat, indicating the depth of the conversation. Accompanying icons provide additional context on interaction types.
     </Tab>
   </Tabs>
