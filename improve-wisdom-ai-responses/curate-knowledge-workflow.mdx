...
2. View **Chat Log entries**. The Chat Log displays a tabular view of interactions, with each row representing a chat entry and providing key metadata:
   ...
   <Tabs>
     ...
     <Tab title="Responses">
       Displays the number of responses within a chat, indicating the depth of the conversation. Accompanying icons provide additional context on interaction types (e.g. If [negative feedback](/setting-up-wisdom-ai/feedback-mechanisms/monitor-negative-feedback) has been given or if the answer has [limited context](/setting-up-wisdom-ai/feedback-mechanisms/limited-context)).
     </Tab>
   </Tabs>
...
- [Enhancing Data Analysis with Custom Business Context](/improve-wisdom-ai-responses/enhancing-data-analysis-with-custom-business-context)