...
og:description: "WisdomAI allows you to connect your domain to an unstructured repository or dataset from an Amazon S3 bucket, thereby enhancing your chatbot responses and"
---
...
3. Click **Add Data Source** to continue.
   <Frame>
     <img
       src="/dark-img/add-data-source.png"
       alt="Domain Add Data Source"
       lightAlt="Domain Add Data Source"
       darkAlt="Domain Add Data Source"
       className="hidden dark:block"
     />
     <img
       src="/images/domain-add-data-source.png"
       alt="Domain Add Data Source"
       lightAlt="Domain Add Data Source"
       darkAlt="Domain Add Data Source"
