...
<img
  ...
  style={{ width:"95%" }}
  lightAlt="Chat workstream showing the edit button"
  darkAlt="Chat workstream showing the edit button"
/>
<img
  src="/dark-img/chat-workstream-edit.png"
  alt="Chat workstream showing the edit button"
...
<img
  src="/images/update-response.png"
  alt="Update response option"
  lightAlt="Update response option"
  darkAlt="Update response option"
  className="dark:hidden"
/>
<img
  src="/dark-img/update-response.png"
  alt="Update response option"
  lightAlt="Update response option"
  darkAlt="Update response option"
...
<Frame>
  <img
    src="/images/NEW-add-knowledge-steps.png"
  ...
  />
  <img
    src="/dark-img/NEW-add-knowledge-steps.png"
    alt="NEW Add Knowledge Steps"
    lightAlt="NEW Add Knowledge Steps"
    darkAlt="NEW Add Knowledge Steps"
    className="hidden dark:block"
...
<img
  ...
  alt="Review question option"
  lightAlt="Review question option"
  darkAlt="Review question option"
  className="dark:hidden"
/>
<img
  src="/dark-img/review-question.png"
  alt="Review question option"
  lightAlt="Review question option"
  darkAlt="Review question option"
  className="hidden dark:block"
...
<img
  src="/images/new-ui-reviewed-queries-01.png"
  alt="Reviewed queries are displayed"
  lightAlt="Reviewed queries are displayed"
  darkAlt="Reviewed queries are displayed"
  className="dark:hidden"
/>
<img
  src="/dark-img/new-ui-reviewed-queries-01.png"
  alt="Reviewed queries are displayed"
  lightAlt="Reviewed queries are displayed"
  darkAlt="Reviewed queries are displayed"
  className="hidden dark:block"
