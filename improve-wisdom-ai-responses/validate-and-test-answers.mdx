...
1. Navigate to **Domains** \> (Select your Domain) \> **Context** \> **Knowledge** and click **Add Knowledge**.
...
<Info>
  To learn more about adding context to a domain, refer to the **[Add Domain-Specific Context](/setting-up-wisdom-ai/add-domain-specific-knowledge)** guide.
</Info>
