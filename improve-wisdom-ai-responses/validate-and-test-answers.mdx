...
- [**Using the thumbs up/down icons**](#use-the-thumbs-updown-icons)
...
1. Go to **Domains** \> (Access the Specific Domain) \> **Knowledge** \> **Context** section to add or modify domain-specific knowledge and information in natural language sentences and click on **Add Context**.
   ...
   Note: This helps the system understand your business context and formulate more precise queries. For example, you can define terms like "Regions are same as Territories" or clarify "My sales stages are: Prospect, Negotiation, Closed." This direct manipulation of the context allows you to guide the chatbot's understanding and improve its ability to generate relevant SQL queries.
