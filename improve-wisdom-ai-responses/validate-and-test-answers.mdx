...
This guide is for Administrators responsible for ensuring the accuracy of WisdomAI responses. This workflow typically begins after an end-user provides negative feedback on an answer.
...
- **Test for Accuracy:** Try rephrasing the original question in a few different ways (e.g., "revenue by region" vs. "how much did each territory earn?"). If the system doesn't return the correct answer, you may need to [Add Knowledge](/setting-up-wisdom-ai/add-domain-specific-knowledge) to help it with precise queries.
...
4. Click **SAVE**. This helps the system formulate more precise queries.
