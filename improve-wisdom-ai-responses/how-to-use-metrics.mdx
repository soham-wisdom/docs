---
title: "How to Use Metrics"
description: "Learn how to create and use metrics effectively for data analysis and tracking business performance in WisdomAI. Explore the interface and practical examples for all metric types."
---

Metrics are essential for understanding your data. Simply put, they are numeric, quantitative values that can be measured to assess and track business performance. These quantifiable measurements help you identify trends and make informed decisions. You might also hear them called "Measures" in some analytics tools. This guide will walk you through how to create and use metrics effectively in WisdomAI.

## Types of Metrics

Not all metrics are created equal. Here's a breakdown of the common types:
...
The process of creating a metric in WisdomAI is managed within specific Domains.
...
2. Click the **Add Metric** button on the Metrics tab.
3. **Configure Your Metric**. In the "Add a Metric" modal window that opens, you will be prompted to provide the following information:
   - **Metric name:** Give your metric a clear, concise name that accurately describes what it measures.
   - **Calculation Method:** Select how the metric will be defined. Common options include:
     ...
     - **LLM Prompt:** Use a Large Language Model (LLM) to define the metric by providing a natural language prompt.
     - **Explain SQL in English** (Beta) Describe your desired SQL calculation in plain English, and the system will attempt to generate the corresponding SQL.
     - **Calculation Area:** Based on your chosen calculation method, you can use the large text area to input your SQL expression, LLM prompt, or English explanation.
4. Toggle the **Advanced Options** switch to reveal additional configurations:
   ...
   - **Associated group-by columns (Optional):** Here, you can pre-define columns that are commonly used for grouping or segmenting this metric. This can streamline analysis by suggesting common dimensions to break down the metric by.
5. Once you have configured your metric, click **Save:**  to add it to your domain's metrics list.

## Sales Metrics Examples

Let's look at some practical examples of sales metrics and how they might be configured. In a tool like WisdomAI, you can define these using SQL expressions, and they would appear in your Metrics list alongside their descriptions and display formats.
...
When you create metrics, especially in platforms that use SQL, you'll define the SQL expression that dictates how the metric is calculated from your raw data. This allows for precise and powerful data analysis.
