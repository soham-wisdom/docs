...
4. Toggle the **Advanced Options** switch to access additional configurations:
...
When you create metrics, you define the SQL expression that dictates how the metric is calculated from your raw data. This allows for precise and powerful data analysis. Once defined, they will appear in your Metrics list with their descriptions and display formats.
