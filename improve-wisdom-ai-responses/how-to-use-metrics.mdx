...
![Add Metrics Pn](/images/add-metrics.png)
...
3. **Configure Your Metric**. In the Add a Metric modal window that opens, you will be prompted to provide the following information:
   ...
   - **Calculation Method:** Select how the metric will be defined. The options include:
     ...
     ![3 And Sql Expression Pn](/images/3-and-sql-expression.png)
     ...
     ![Llm Prompt Pn](/images/llm-prompt.png)
     - **Explain SQL in English** (Beta) Describe your desired SQL calculation in plain English and click on **Test** _(a previous step before saving your result)_. The system will attempt to generate the corresponding SQL.

     ![Sql Explain Pn](/images/sql-explain.png)
4. Fill in the **Text/SQL Expression Area:** Based on your chosen calculation method, you can use the large text area to input your SQL expression, LLM prompt, or English explanation.
...
![Add Metric 45and6 Pn](/images/add-metric-45and6.png)
