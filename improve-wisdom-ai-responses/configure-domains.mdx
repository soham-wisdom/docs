...
<AccordionGroup>
  <Accordion title="The Overview Tab">
    ...
    ![Overview Tab Pn](/images/overview-tab.png)
  </Accordion>
  <Accordion title="The Data Sources Tab">
    ...
    ![Tables Tab Pn](/images/tables-tab.png)
    ...
    ![Tables Tabv2 Pn](/images/tables-tabv2.png)
  </Accordion>
  <Accordion title="The Knowledge Tab">
    ...
    ![Context Tab Pn](/images/context-tab.png)
    ...
    ![Rev Queries Tab Pn](/images/rev-queries-tab.png)
    ...
    ![Metrics Tab Pn](/images/metrics-tab.png)
    ...
    ![Entities Tab Pn](/images/entities-tab.png)
  </Accordion>
  <Accordion title="The Advanced Tab">
    ...
    - **Chat Customization:** A text area for providing system instructions to the AI.
  </Accordion>
  <Accordion title="The Evaluation Tab">
    ...
    - **Evaluation Sets Sub-tab:**
      - **Add Evaluation:** A button to create a new evaluation set.
      - **Add Evaluation Form:** Includes fields for the set name and a JSON input for prompts, optionally including expected SQL.
