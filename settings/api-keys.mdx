...
See the [GraphQL API](/integrations/graphql-api/GraphQL-API) and [WisdomAI MCP Server](/integrations/mcp-server) documentation for full request examples.
...
<CardGroup cols={2}>
  ...
  <Card title="WisdomAI MCP Server" icon="plug" href="/integrations/mcp-server">
