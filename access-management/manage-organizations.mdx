...
<Frame>
  <img
    src="/images/create-new-organization.png"
    alt="Create New Organization UI"
...
4. In the modal that opens, under **Organization Details**: 
   ...
   4. Define the **URI** (e.g., `finance`). This creates a unique access point: `https://try.askwisdom.ai/organizations/finance`. 
   4. Add **Organization Admins** by entering their email addresses. 
   4. (Optional) Expand **Advanced Options** to define **Allowed email domains**.
...
<Frame>
  <img
    src="/images/edit-organizations-02.png"
    alt="Edit Organizations modal"
  />
</Frame>
