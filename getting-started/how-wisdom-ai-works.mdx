...
<Columns cols={2}>
  ...
  <Card title="Turns Answers into Dashboards" icon="chart-simple">
    Instead of just giving you numbers, WisdomAI can create interactive **Dashboards** and dashboards with charts and text. These stories update automatically as your data changes, making it easy to share insights across your team.
  </Card>
</Columns>
...
<Frame>
  <img
    src="/images/diagram-dark-mode.png"
    alt="Data Sources Flow Connect Pn"
    height="400"
    lightAlt="Data Sources Flow Connect"
...
<CardGroup cols={3}>
  ...
  <Card title="Turn Answers into Dashboards" icon="book" href="/using-wisdom-ai-everyday/turn-answers-into-stories">
