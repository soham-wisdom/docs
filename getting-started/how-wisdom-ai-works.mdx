...
description: >-
  WisdomAI is a platform that helps businesses analyze their data and make
  informed decisions.
keywords:
  - what is WisdomAI
  - product overview
...
<Card title="Developers" icon="code" horizontal>
...
<Steps>
  ...
  <Step title="Dashboard Creation" stepNumber={4} titleSize="h3">
