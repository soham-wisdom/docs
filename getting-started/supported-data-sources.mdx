...
Bringing all your data together helps you understand it better. When you connect your databases, data warehouses, and CSV files to WisdomAI, you will have all your information from different places in one spot. This unified view means you can easily analyze everything and create helpful reports. Once your data is linked, you can simply ask questions in plain language and get immediate answers from your integrated datasets.

## Data Sources

WisdomAI works with the following types of data sources:

**Databases:** PostgreSQL and Microsoft SQL Server.
**Data Warehouses:** Databricks, Snowflake, Google BigQuery, and Amazon Redshift.
**Files:** CSV files.

To add database or data warehouse connections, navigate to the **"Connections"** tab in the WisdomAI interface.

To upload CSV files, use the **"Upload CSV"** button available on the home page.
...
- **Database User Permissions:** For databases and data warehouses, a user with read-only access to the relevant tables and schemas is highly recommended for security.
...
<Tabs>
  <Tab title="PostgreSQL">
    ...
    **Example Connection**
    ...
    Host: [postgres.example.com](http://postgres.example.com)
  ...
  <Tab title="Microsoft SQL Server">
    ...
    **Example Connection**
    ...
    Server: [sqlserver.example.com](http://sqlserver.example.com)
  ...
  <Tab title="Databricks">
    ...
    **Example Connection**
    ...
    Server Hostname: [dbc-xxxx-yyyy.cloud.databricks.com](http://dbc-xxxx-yyyy.cloud.databricks.com)
  ...
  <Tab title="Snowflake">
    ...
    **Example Key Pair Connection**

    ```
    
    Account: [xy12345.us](http://xy12345.us)-east-1
    ...
    <Info>
      Snowflake Key Pair Authentication Documentation: [Link to Snowflake Docs](https://docs.snowflake.com/en/user-guide/key-pair-auth.html) (You would replace this with the actual link).
    </Info>
  </Tab>
...
WisdomAI works with leading ETL partners to provide data integration from various SaaS applications.
...
To integrate data from SaaS applications, please contact WisdomAI support. Our team will work with you to set up the appropriate ETL pipelines using our partner technologies.

<warning>
  Contact Support for SaaS Integration
</warning>
...
- **Throughput/Query Limits:** Be aware of any rate limits or query concurrency limits imposed by your database or data warehouse provider. WisdomAI's queries will contribute to these limits.
- **Data Type Support:** While WisdomAI strives to support a wide range of data types, some highly specialized or proprietary data types might require specific handling or may not be fully supported.
