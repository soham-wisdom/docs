...
To add data sources connections, read the [Basic Tutorial: Connect and Test](/setting-up-wisdom-ai/basic-tutorial-connect-and-test).
...
<Tabs>
  ...
  <Tab title="Snowflake">
    ...
    **Example Key Pair Connection**
    ...
    Snowflake Key Pair Authentication Documentation: [Link to Snowflake Docs](https://docs.snowflake.com/en/user-guide/key-pair-auth.html).
  </Tab>
