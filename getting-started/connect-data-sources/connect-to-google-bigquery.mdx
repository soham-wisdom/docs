...
Before connecting WisdomAl to BigQuery, ensure you have:
...
A service account is a special type of Google account that an application, like WisdomAl, can use to make authorized API calls.
...
**Steps to Assign Roles (at Project Level):**
...
**To Restrict Access to Specific Datasets Only:**
...
6.  Click **CREATE**.
7.  A JSON key file will be downloaded to your computer. This file contains sensitive credentials.
