...
<Frame>
![client-id-secret](/images/client-id-secret.jpg)
</Frame>

\[SCREENSHOT: Google Cloud OAuth client confirmation dialog displaying the Client ID and Client Secret\]

Enter credentials and authenticate in WisdomAI
