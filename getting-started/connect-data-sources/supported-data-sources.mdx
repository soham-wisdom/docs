...
<Tabs>
  ...
  <Tab title="Teradata">
    ...
    <Note>
      Database filters are optional, but it is recommended to specify only the databases that you want to expose to Wisdom. <img src="/images/databasefilters.png" alt="databasefilters" />
    </Note>
