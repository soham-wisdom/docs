...
sidebarTitle: "Connect an external MCP server"
boost: 6
keywords: ['mcp', 'mcp server', wisdom mcp]
---

WisdomAI allows you to connect to any server that implements the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/docs/getting-started/intro). This integration enables WisdomAI to scan metadata, build a knowledge graph, and fetch real-time data to generate visualizations when users ask natural-language questions.

<Note>
  To connect an AI client to WisdomAI's hosted MCP server, see [WisdomAI MCP Server](/integrations/mcp-server).
</Note>
...
7. (Optional) Click **\+ Add Header** to include custom headers required by your environment.
   <img
     alt="Mcp 01"
     lightAlt="MCP Server connection settings showing Transport Type and Authentication options"
     darkAlt="MCP Server connection settings showing Transport Type and Authentication options"
     title="Mcp 01"
     src="/images/mcp-01.png"
   ...
   <img
     ...
     darkAlt="MCP Server connection settings showing Transport Type and Authentication options"
     title="Mcp 01"
     src="/dark-img/mcp-server.png"
     className="hidden dark:block"
   />
8. Click **Connect**. You may be prompted to authorize the connection to validate the setup.

<img
  src="/images/mcp-03-access-request.png"
  alt="Chat interface prompting the user to authenticate with the MCP tool"
  lightAlt="Chat interface prompting the user to authenticate with the MCP tool"
  darkAlt="Chat interface prompting the user to authenticate with the MCP tool"
  className="dark:hidden"
/>
<img
  src="/dark-img/mcp-03-access-request.png"
  alt="Chat interface prompting the user to authenticate with the MCP tool"
  lightAlt="Chat interface prompting the user to authenticate with the MCP tool"
  darkAlt="Chat interface prompting the user to authenticate with the MCP tool"
  className="hidden dark:block"
