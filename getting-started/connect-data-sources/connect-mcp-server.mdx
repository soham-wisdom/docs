---
title: "Connect to any MCP server from WisdomAI"
sidebarTitle: "Connect to an MCP Server"
boost: 6
og:description: "WisdomAI allows you to connect to any server that implements the Model Knowledge Protocol (MCP). This integration enables WisdomAI to scan metadata, build a"
---
