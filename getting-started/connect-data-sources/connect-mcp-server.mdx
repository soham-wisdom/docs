...
7. (Optional) Click **\+ Add Header** to include custom headers required by your environment.
   <img
     alt="MCP Server connection settings showing Transport Type and Authentication options"
     ...
     src="/mcp-01.png"
   />
8. Click **Connect**. You may be prompted to authorize the connection to validate the setup. <img src="/images/mcp-03-access-request.png" alt="Chat interface prompting the user to authenticate with the MCP tool" />
