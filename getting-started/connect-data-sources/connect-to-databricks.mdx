...
og:description: "WisdomAI connects to Databricks using a Client ID and Client Secret for authentication. This method ensures secure and granular control over the data WisdomAI"
---
...
GRANT SELECT ON SCHEMA <your_catalog_name>.<your_schema_name> TO `<service_principal_id>`;
```
...
<img
  ...
  lightAlt="image.png"
  darkAlt="image.png"
  src="/dark-img/databricks-dark.png"
