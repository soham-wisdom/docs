...
1. When configuring the connection as shown in option 1, expand the **SSH Tunnel Configuration** section. 
2. Fill in the standard database details and the SSH Tunnel configuration fields.
...
4. Click **Save and Sync metadata.** 

![Snippet displaying the Add Connection page](/images/redshift-02.png)
