...
og:description: "WisdomAI allows you to connect to Amazon Redshift by choosing one of three methods:"
---
...
<img
  src="/dark-img/redshift-direct-conection.png"
  alt="Snippet displaying the Add Connection page"
  lightAlt="Snippet displaying the Add Connection page"
  darkAlt="Snippet displaying the Add Connection page"
  className="hidden dark:block hidden dark:block"
/>

<img
  src="/images/redshift-01.png"
  alt="Snippet displaying the Add Connection page"
  lightAlt="Snippet displaying the Add Connection page"
  darkAlt="Snippet displaying the Add Connection page"
...
<img
  src="/dark-img/connect-sshTunel.png"
  alt="Snippet displaying the Add Connection page with the SSH Tunnel Configuration section displayed"
  lightAlt="Snippet displaying the Add Connection page with the SSH Tunnel Configuration section displayed"
  darkAlt="Snippet displaying the Add Connection page with the SSH Tunnel Configuration section displayed"
  className="hidden dark:block"
/>
<img
  src="/images/redshift-02.png"
  alt="Snippet displaying the Add Connection page with the SSH Tunnel Configuration section displayed"
  lightAlt="Snippet displaying the Add Connection page with the SSH Tunnel Configuration section displayed"
  darkAlt="Snippet displaying the Add Connection page with the SSH Tunnel Configuration section displayed"
  className="dark:hidden"
