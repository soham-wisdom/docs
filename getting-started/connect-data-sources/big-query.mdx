...
Once you have set up the prerequisites, you can configure the connection in WisdomAl:
...
{/* TODO: Add screenshot of the Google Cloud client ID and secret confirmation dialog (previously /images/client-id-secret.jpg, which was never committed to the repo). */}
...
{/* TODO: Add screenshot of the Google Sign-In account selection popup (previously /images/image2[1].jpg, which was never committed to the repo). */}
...
<img
  src="/images/create-client-oauth.png"
  className="dark:hidden"
/>
<img
  src="dark-img/bigquery-dark.png"
