...
<Tabs>
  ...
  <Tab title="Developers">
    **Objective:** Integrate WisdomAI into your product or connect it to your toolchain.
    ...
    **Start Here:**
    ...
    <Columns cols={2}>
      ...
      <Card title="MCP Server" icon="plug" horizontal href="/integrations/mcp-server/MCP-Server">
      </Card>
    </Columns>

    **Key Actions:**

    - Embed WisdomAI dashboards and chat into your web app using the iframe or React SDK.
