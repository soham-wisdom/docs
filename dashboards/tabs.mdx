...
<CardGroup cols={2}>
  <Card title="Build Dashboards" icon="table-layout" href="https://docs.wisdom.ai/improve-wisdom-ai-responses/build-dashboards">
    Arrange widgets, add summaries, and prepare a dashboard for sharing.
  </Card>

  <Card title="Share Dashboards and Set Access Control" icon="lock" href="https://docs.wisdom.ai/using-wisdom-ai-everyday/share-dashboards-and-set-access-control">
