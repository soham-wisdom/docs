...
keywords: ["dual axis graph"]
boost: 0.2
og:description: "Dual-Axis Charts, also known as combo charts, are visualizations that combine multiple chart types or Y-axes into a single view. They allow you to display"
---
...
<CardGroup cols={2}>
  ...
  <Card icon="flask" href="/product-updates/february-2026/knowledge-playground" title="Knowledge Playground">
