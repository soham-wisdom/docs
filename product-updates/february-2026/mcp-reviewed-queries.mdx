...
boost: 0.3
og:description: "MCP Reviewed Queries extends the existing reviewed queries system to support visualizations generated from Model Context Protocol (MCP) tool calls. When you"
---
...
<CardGroup cols={2}>
  ...
  <Card icon="chart-pie" href="/product-updates/february-2026/mcp-in-dashboards" title="MCP Visualizations in Dashboards">
