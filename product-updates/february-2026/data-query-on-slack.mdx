...
og:description: "Slack in Channels allows you to @mention @WisdomAI in public or private Slack channels to ask data questions collaboratively. Previously, the Slack app only"
---
