---
title: "Context Builder - File uploads"
og:description: "Context Builder is a feature within WisdomAI's Adaptive Context Engine (wACE) that helps you build your Domain's context by using existing documentation. By"
---
