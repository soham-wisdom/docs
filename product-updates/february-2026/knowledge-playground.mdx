...
og:description: "The Knowledge Playground is a dedicated workspace for turning business questions into reliable, reusable SQL and clear results. It provides a separate"
---
...
<video src="/videos/knowledge_playground-video02.mp4" controls={true} />
...
<CardGroup cols={2}>
  <Card icon="wand-magic-sparkles" href="/product-updates/february-2026/context-builder-file-uploads" title="Context Builder - File uploads">
