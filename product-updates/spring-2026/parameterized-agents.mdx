...
<Steps>
  ...
  <Step title="Manage subscriptions and templates" icon="users-gear">
    ...
    - Row-level security and parameterized data source execute under the agent runner's (owner's) identity, and RLS/CLS uses the runner's permissions, not each subscriber's.
