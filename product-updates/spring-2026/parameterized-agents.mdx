...
<Steps>
  ...
  <Step title="Collect runtime parameters" icon="input-text">
    When a user manually triggers a parameterized agent, a generated input form collects their values. Submitted values are injected throughout the agent's prompts and node configurations injected wherever you reference the parameter.
  </Step>
