...
boost: 0.3
og:description: "Parameterized Agents let you define an input schema on any agent so it accepts runtime variables, an org ID, a department name, a list of assets to analyze, or"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Create an Agent" icon="wand-magic-sparkles" href="/setting-up-wisdom-ai/agents/tutorial-create-agent">
