...
<Update label="Updates">
  ...
  <Note>
    **Updated in August 2026** — Knowledge Signals from Chat now includes automatic mid-chat capture. See the [August 2026 Product Update](/product-updates/august-2026/august-changelog#-knowledge-signals-from-chat) for what's new.
  </Note>
