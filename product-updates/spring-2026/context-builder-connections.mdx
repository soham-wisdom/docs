...
keywords: ["GitHub", "GitHub connection", "connection prerequisites", "connect GitHub"]
og:description: "Metric definitions, business rules, and table descriptions live across GitHub repositories, dbt YAML files, Looker models, and data catalogs — and the moment"
---
...
<img src="/videos/context-builder-v02.gif" alt="Gif showing the Context Builder connection flow" />
