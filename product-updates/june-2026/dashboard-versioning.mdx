...
og:description: "Dashboard Versioning introduces a draft/publish model for dashboards and their widgets. Every change you make creates a draft that does not affect the version"
---
