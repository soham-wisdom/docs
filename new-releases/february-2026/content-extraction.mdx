---
title: "WisdomAI Context Extraction"
---

Context Extraction is a feature within the Adaptive Context Engine (wACE) that helps you build your Domain by using existing documentation. By uploading files like dbt YAML, internal docs, PDFs, or query logs, the system identifies and proposes suggestions tailored to your data environment. 
...
1. Navigate to your domain page to upload files. You can optionally provide a short prompt to steer the engine toward specific logic or business context you want to find.

2. Wisdom analyzes the content and proposes structured items. When possible, the system validates these suggestions based on SQL execution to ensure the logic is accurate. All proposals appear in the **Suggestions** experience. You can compare the suggestion side-by-side with the source content. 

3. From this view, you can click **Accept**, **Reject**, or **Edit** before the information is published.
