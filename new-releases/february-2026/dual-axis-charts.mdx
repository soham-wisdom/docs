...
- **Layout Mapping:** The system explicitly defines what data appears on the X-axis, which measures belong to each Y-axis, and the rendering position for each series. Explicit specifications of chart structure **(ChartLayoutSpec)** include:
...
<AccordionGroup>
  ...
  <Accordion title="Can I mix different chart styles?">
    Yes. Combo charts can combine bars, lines, or area series in a single visualization.
  </Accordion>
