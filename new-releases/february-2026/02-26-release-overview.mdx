...
<CardGroup cols={2}>
  <Card icon="wand-magic-sparkles" href="new-releases/february-2026/content-extraction.mdx" title="Context Extraction">
    Transform existing documentation into standardized metrics and joins in minutes.
  </Card>
  <Card icon="slack" href="new-releases/february-2026/data-query-on-slack.mdx" title="Slack in Channels">
