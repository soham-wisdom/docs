...
<CardGroup cols={2}>
  <Card icon="wand-magic-sparkles" href="/setting-up-wisdom-ai/context-extraction" title="Context Extraction">
    Learn how to automatically generate suggestions from your existing documentation.
  </Card>
  <Card icon="layer-group" href="/manage-domains/understand-domains" title="Manage Domains">
