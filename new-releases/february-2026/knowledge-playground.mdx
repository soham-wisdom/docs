...
### 2. Iterate on the SQL
Review the generated SQL and edit it manually as needed. You can click **Retry** or update the code directly until the logic matches your intent.

### 3. Run, Validate, and Save
Click **Execute** to run the query and inspect the results in the table and visualization views. Once you confirm the output is correct and tells the right story, click **Save** to finalize the query for future reuse.
...
<AccordionGroup>
  ...
  <Accordion title="Do I need special access to use it?">
    You may need elevated permissions depending on your workspace settings. If you cannot click **Execute** or **Save**, check with your workspace administrator.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Context Extraction" icon="wand-magic-sparkles" href="/setting-up-wisdom-ai/context-extraction">
