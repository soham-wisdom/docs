...
This guide covers the visualization features within WisdomAI's **Stories and Chats**. It explains how to analyze trends, compare categories, and adjust data display settings.
...
WisdomAI's Stories support a variety of chart types to represent data insights effectively. Users can select the desired chart type through a dropdown menu in the **Editor** tab.
...
<CardGroup cols={2}>
  ...
  <Card title="Advanced Data Modeling: Creating Knowledge" icon="sitemap" href="/setting-up-wisdom-ai/advanced-data-modeling-creating-knowledge">
