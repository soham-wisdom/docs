---
title: "Chart and Graph Types and Properties"
keywords: ["map chart", "world map", "GIS", "geospatial", "heatmap", "graph"]
boost: 7
---
...
- The catalog of available **chart and graph types** to represent your data visually.
...
## Chart and graph catalog

WisdomAI's Dashboards support a variety of chart and graph types to represent data insights effectively. Users can select the desired chart type through a dropdown menu in the **Editor** tab.

![Image showing the editor tab charts list](/images/editor-tab-charts-list.png)

### Available chart and graph types
...
<CardGroup cols={2}>
  ...
  <Card title="Advanced Data Modeling: Creating Context" icon="sitemap" href="/setting-up-wisdom-ai/advanced-data-modeling-creating-context">
