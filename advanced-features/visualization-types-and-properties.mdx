...
keywords: ["graph", "viz", "vizualization", "vizua", "graphs", "chart types", "map chart", "world map", "GIS", "geospatial", "heatmap"]
boost: 15
og:description: "This guide covers the visualization features within WisdomAI's Dashboards and Chats. It explains how to analyze trends, compare categories, and adjust data"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Build Dashboards" icon="table-cells-large" href="/improve-wisdom-ai-responses/build-dashboards">
