...
description: "Overview of chart types, encodings, interactivity, and accessibility in WisdomAI Stories and chats."
---

This reference guide outlines the visualization capabilities within **WisdomAI's Stories and chats**. Whether you are analyzing trends, comparing categories, or refining how data is displayed, WisdomAI provides a flexible interface for creating effective visual narratives.
