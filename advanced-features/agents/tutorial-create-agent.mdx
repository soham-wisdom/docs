...
3. **Select an Agent**: Choose **Promp Agent** in the **Create Agent** modal. A prompt form will open.

<Note>
  At the top right of the form you can select **Prompt** or [**Visual**](/advanced-features/agents/visual-mode) mode on the **toggle button**.
