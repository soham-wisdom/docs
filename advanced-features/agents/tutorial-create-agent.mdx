...
- **A delivery channel**: Email or Slack, ready to configure. To deliver to Slack, an administrator must first connect your Slack workspace to WisdomAI.
  <Note>
    See the [Slack](https://docs.askwisdom.ai/integrations/connect-to-slack) guide for setup steps.
  </Note>
...
<Note>
  ...
  <img
    alt="Screenshot showing Visual mode"
    lightAlt="Screenshot showing Visual mode"
    darkAlt="Screenshot showing Visual mode"
    src="/images/visual-mode.png"
  />
</Note>

3. **Agent Name**: Provide a descriptive name for your Agent to easily identify it later.
4. Configure the **Activation** **Trigger**. The optional trigger allows you to choose between two modes of operation: scheduled reporting or conditional monitoring.
...
<CardGroup cols={2}>
  <Card title="Manage Your Agents" icon="sliders" href="https://docs.askwisdom.ai/advanced-features/agents/manage-agents">
