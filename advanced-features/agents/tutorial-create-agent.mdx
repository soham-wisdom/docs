...
<img
  src="/images/2025-08-26_12-26-03.png"
  alt="Screenshot showing the Get Started button"
  lightAlt="Screenshot showing the Get Started button"
  darkAlt="Screenshot showing the Get Started button"
  className="dark:hidden"
/>
<img
  src="/dark-img/2025-08-26_12-26-03-1.png"
  alt="Screenshot showing the Get Started button"
  lightAlt="Screenshot showing the Get Started button"
  darkAlt="Screenshot showing the Get Started button"
...
<img
  src="/images/agent-new-ui-02.png"
  alt="Agent configuration screen with trigger enabled"
  lightAlt="Agent configuration screen with trigger enabled"
  darkAlt="Agent configuration screen with trigger enabled"
  className="dark:hidden"
/>
<img
  src="/dark-img/agent-new-ui-02-1.png"
  alt="Agent configuration screen with trigger enabled"
  lightAlt="Agent configuration screen with trigger enabled"
  darkAlt="Agent configuration screen with trigger enabled"
  className="hidden dark:block"
...
<img
  src="/images/agent-new-ui-09.png"
  alt="Create Agent button to save and activate the agent"
  lightAlt="Create Agent button to save and activate the agent"
  darkAlt="Create Agent button to save and activate the agent"
  className="dark:hidden"
/>
<img
  src="/dark-img/agent-new-ui-09.png"
  alt="Create Agent button to save and activate the agent"
  lightAlt="Create Agent button to save and activate the agent"
  darkAlt="Create Agent button to save and activate the agent"
  className="hidden dark:block"
...
<img
  src="/images/agent-new-ui-gif.gif"
  alt="Gif showing the Test button in action"
  lightAlt="Gif showing the Test button in action"
  darkAlt="Gif showing the Test button in action"
  className="dark:hidden"
/>
<img
  src="/dark-img/agent-new-ui-gif.gif"
  alt="Gif showing the Test button in action"
  lightAlt="Gif showing the Test button in action"
  darkAlt="Gif showing the Test button in action"
  className="hidden dark:block"
...
<img
  src="/images/agent-new-ui-da.png"
  alt="Snippet showing the Deep Analysis toggle enabled"
  lightAlt="Snippet showing the Deep Analysis toggle enabled"
  darkAlt="Snippet showing the Deep Analysis toggle enabled"
  className="dark:hidden"
/>
<img
  src="/dark-img/agent-new-ui-da.png"
  alt="Snippet showing the Deep Analysis toggle enabled"
  lightAlt="Snippet showing the Deep Analysis toggle enabled"
  darkAlt="Snippet showing the Deep Analysis toggle enabled"
  className="hidden dark:block"
