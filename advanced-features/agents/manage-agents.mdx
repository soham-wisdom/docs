...
Use Role-Based Access Control (RBAC) to manage collaboration. Use the table below to understand the differences between Editor and Viewer permissions and how they respect existing data access rules.
