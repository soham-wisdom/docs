...
<Columns cols={2}>
  <Card title="Create an Agent" icon="1" horizontal href="/agents/tutorial-create-angent">
    
  </Card>
  <Card title="Manage Your Agents" icon="2" horizontal href="/agents/manage-agents">
