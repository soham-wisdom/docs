...
<Columns cols={2}>
  <Card title="Create an Agent" icon="1" horizontal href="https://docs.askwisdom.ai/advanced-features/agents/tutorial-create-agent">
    
  </Card>
  <Card title="Manage Your Agents" icon="2" horizontal href=https://docs.askwisdom.ai/advanced-features/agents/manage-agents">
...
Learn how to create an agent and then how to manage it.
