...
<Frame>
  <img
    alt="Agent configuration screen in WisdomAI showing trigger and work description fields"
    lightAlt="Agent configuration screen in WisdomAI showing trigger and work description fields"
    darkAlt="Agent configuration screen in WisdomAI showing trigger and work description fields"
