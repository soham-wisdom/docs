...
| Trigger | When to use |
| --- | --- |
| **Manual trigger** | Starts when you run the agent manually. Use this when you need to run the analysis on demand. |
...
| Trigger mis-fires | Adjust the trigger threshold |
