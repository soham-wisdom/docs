...
Visual Mode lets you build an agent as an explicit, node-based workflow on a canvas. You define each step—trigger, data, AI reasoning, artifact, delivery—and the agent executes those exact steps on every run.
