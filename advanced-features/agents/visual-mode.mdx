...
Visual Mode lets you build an agent as an explicit, node-based workflow on a canvas. You define each step-trigger: data, AI reasoning, artifact and delivery. The agent executes those exact steps on every run.
...
Visual Mode is the default view when you open the Agent Builder. Click **Create Agent** to open a model and pick **Prompt agent** or **Visual agent**. Choose Visual agent to open the canvas.
...
Every time you edit an agent a new version is published. Versions give you a history of every change, so you can see what a past publish looked like or restore it if a newer change causes problems.

<img
  src="/images/visual-versioning.png"
  alt="Snippet showing the versioning"
  lightAlt="Snippet showing the versioning"
  darkAlt="Snippet showing the versioning"
  className="dark:hidden"
/>
<img
  src="/images/view-data.png"
  alt="Snippet showing the versioning"
  lightAlt="Snippet showing the versioning"
  darkAlt="Snippet showing the versioning"
