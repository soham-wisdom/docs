...
<Note>
  For a full description of node types and how they behave, see the [Node Reference](/advanced-features/agents/node-reference).
</Note>
...
<Frame>
  ![Add node snippet](/images/15-04-2026_09-08-10.PNG)
</Frame>

3. Click on it to write an instruction in the node's settings panel describing what it should do with its input.
4. Click **Done**.
   <Frame>
     ![Snippet showing how instructions are written for the node](/images/15-04-2026_09-20-41.PNG)
   </Frame>
...
3. At any point during or after the run, click on a node to review the data generated, the analysis performed, and the underlying SQL or Python code used.
   <Frame>
     ![Snippet showing the data fetched by the node](/images/view-data.png)
   </Frame>
...
<Frame>
  ![Image showing the publish Agent button in the UI](/images/publish-agent.png)
</Frame>
