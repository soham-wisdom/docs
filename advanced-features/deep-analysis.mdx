...
<Tip>
  This page describes the standalone **Deep Analysis** chat toggle from the previous chat experience. If you're on Chat 2.0, this has been replaced by **[Expert mode](/chat/expert-mode)**, which runs inside the normal chat flow instead of a separate toggle. If your organization is still on the previous chat experience, the steps below still apply.
</Tip>
