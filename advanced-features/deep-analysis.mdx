...
tag: "Older - V.1 Chat"
og:description: "Use the Deep Analysis feature to investigate complex, open-ended questions, such as \"Why did our revenue spike last quarter?\". The feature automates the"
---

<Tip>
  This page describes the standalone **Deep Analysis** chat toggle from the previous chat experience. It's been replaced by **Expert** mode in [Chat 2.0](/chat/overview#choose-a-mode), which runs inside the normal chat flow instead of a separate toggle.
</Tip>
